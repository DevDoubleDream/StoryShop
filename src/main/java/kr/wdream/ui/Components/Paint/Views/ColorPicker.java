package kr.wdream.ui.Components.Paint.Views;
...
public class ColorPicker extends FrameLayout {
    ...
    public ColorPicker(Context context) {
        ...
        shadowDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.knob_shadow);
        ...
        settingsButton.setImageResource(kr.wdream.storyshop.R.drawable.photo_paint_brush);
