...
import kr.wdream.ui.Cells.JoinSheetUserCell;
...
public class JoinGroupAlert extends BottomSheet {
    ...
    public JoinGroupAlert(final Context context, TLRPC.ChatInvite invite, String group, BaseFragment parentFragment) {
        ...
        pickerBottomLayout.cancelButton.setText(LocaleController.getString("Cancel", kr.wdream.storyshop.R.string.Cancel).toUpperCase());
        ...
        pickerBottomLayout.doneButtonTextView.setText(LocaleController.getString("JoinGroup", kr.wdream.storyshop.R.string.JoinGroup));
