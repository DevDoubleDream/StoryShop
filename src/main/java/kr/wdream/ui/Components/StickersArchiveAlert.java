...
import kr.wdream.ui.Cells.ArchivedStickerSetCell;
...
public class StickersArchiveAlert extends AlertDialog.Builder {
    ...
    public StickersArchiveAlert(Context context, BaseFragment baseFragment, ArrayList<TLRPC.StickerSetCovered> sets) {
        ...
        if (set.set.masks) {
            ...
            setTitle(LocaleController.getString("ArchivedMasksAlertTitle", kr.wdream.storyshop.R.string.ArchivedMasksAlertTitle));
        } else {
            currentType = StickersQuery.TYPE_IMAGE;
            setTitle(LocaleController.getString("ArchivedStickersAlertTitle", kr.wdream.storyshop.R.string.ArchivedStickersAlertTitle));
        }
        ...
        if (set.set.masks) {
            textView.setText(LocaleController.getString("ArchivedMasksAlertInfo", kr.wdream.storyshop.R.string.ArchivedMasksAlertInfo));
        } else {
            textView.setText(LocaleController.getString("ArchivedStickersAlertInfo", kr.wdream.storyshop.R.string.ArchivedStickersAlertInfo));
        }
        ...
        setNegativeButton(LocaleController.getString("Close", kr.wdream.storyshop.R.string.Close), new DialogInterface.OnClickListener() {
            @Override
        ...
        if (parentFragment != null) {
            setPositiveButton(LocaleController.getString("Settings", kr.wdream.storyshop.R.string.Settings), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
