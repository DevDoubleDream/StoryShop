...
public class PasscodeView extends FrameLayout {
        ...
        if (Build.VERSION.SDK_INT >= 23 && parentActivity != null && UserConfig.useFingerprint && !ApplicationLoader.mainInterfacePaused) {
            ...
            try {
                ...
                if (fingerprintManager.isHardwareDetected() && fingerprintManager.hasEnrolledFingerprints()) {
                    ...
                    fingerprintTextView.setText(LocaleController.getString("FingerprintInfo", kr.wdream.storyshop.R.string.FingerprintInfo));
                    ...
                    fingerprintStatusTextView.setText(LocaleController.getString("FingerprintHelp", kr.wdream.storyshop.R.string.FingerprintHelp));
                    ...
                    fingerprintManager.authenticate(null, 0, cancellationSignal, new FingerprintManagerCompat.AuthenticationCallback() {
                        ...
                        public void onAuthenticationFailed() {
                            showFingerprintError(LocaleController.getString("FingerprintNotRecognized", kr.wdream.storyshop.R.string.FingerprintNotRecognized));
                        }
    ...
    public void onShow() {
        ...
        passcodeTextView.setText(LocaleController.getString("EnterYourPasscode", kr.wdream.storyshop.R.string.EnterYourPasscode));
    ...
    private void showFingerprintError(CharSequence error) {
        fingerprintImageView.setImageResource(kr.wdream.storyshop.R.drawable.ic_fingerprint_error);
