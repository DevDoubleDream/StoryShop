...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context) {
        ...
        mThumbDrawable = context.getResources().getDrawable(kr.wdream.storyshop.R.drawable.switch_thumb);
        if (mThumbDrawable != null) {
            mThumbDrawable.setCallback(this);
        }
        mTrackDrawable = context.getResources().getDrawable(kr.wdream.storyshop.R.drawable.switch_track);
