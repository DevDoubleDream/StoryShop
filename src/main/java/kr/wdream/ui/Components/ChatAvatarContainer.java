            ...
            if (chat != null) {
                ...
                if (ChatObject.isChannel(chat)) {
                    if (info != null && info.participants_count != 0) {
                        ...
                        if (chat.megagroup) {
                            subtitleTextView.setText(LocaleController.getString("Loading", kr.wdream.storyshop.R.string.Loading).toLowerCase());
                        } else {
                            if ((chat.flags & TLRPC.CHAT_FLAG_IS_PUBLIC) != 0) {
                                subtitleTextView.setText(LocaleController.getString("ChannelPublic", kr.wdream.storyshop.R.string.ChannelPublic).toLowerCase());
                            } else {
                                subtitleTextView.setText(LocaleController.getString("ChannelPrivate", kr.wdream.storyshop.R.string.ChannelPrivate).toLowerCase());
                            }
                        }
                    }
                } else {
                    if (ChatObject.isKickedFromChat(chat)) {
                        subtitleTextView.setText(LocaleController.getString("YouWereKicked", kr.wdream.storyshop.R.string.YouWereKicked));
                    } else if (ChatObject.isLeftFromChat(chat)) {
                        subtitleTextView.setText(LocaleController.getString("YouLeft", kr.wdream.storyshop.R.string.YouLeft));
                    } else {
                ...
                if (user.id == UserConfig.getClientUserId()) {
                    newStatus = LocaleController.getString("ChatYourSelf", kr.wdream.storyshop.R.string.ChatYourSelf);
                } else if (user.id == 333000 || user.id == 777000) {
                    newStatus = LocaleController.getString("ServiceNotifications", kr.wdream.storyshop.R.string.ServiceNotifications);
                } else if (user.bot) {
                    newStatus = LocaleController.getString("Bot", kr.wdream.storyshop.R.string.Bot);
                } else {
