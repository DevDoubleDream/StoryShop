...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean darkTheme) {
        ...
        cancelButton.setText(LocaleController.getString("Cancel", kr.wdream.storyshop.R.string.Cancel).toUpperCase());
        ...
        doneButtonBadgeTextView.setBackgroundResource(isDarkTheme ? kr.wdream.storyshop.R.drawable.photobadge : kr.wdream.storyshop.R.drawable.bluecounter);
