...
import kr.wdream.ui.Cells.FeaturedStickerSetInfoCell;
import kr.wdream.ui.Cells.StickerEmojiCell;
import kr.wdream.ui.StickerPreviewViewer;
...
public class StickersAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (error == null) {
                            ...
                            Toast.makeText(getContext(), LocaleController.getString("ErrorOccurred", kr.wdream.storyshop.R.string.ErrorOccurred) + "\n" + error.text, Toast.LENGTH_SHORT).show();
                            dismiss();
                        }
                    }
                });
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (error == null) {
                                    ...
                                    Toast.makeText(getContext(), LocaleController.getString("AddStickersNotFound", kr.wdream.storyshop.R.string.AddStickersNotFound), Toast.LENGTH_SHORT).show();
                                    dismiss();
                                }
                            }
                        });
    ...
    private void init(Context context) {
        ...
        shadow[0].setBackgroundResource(kr.wdream.storyshop.R.drawable.header_shadow);
        ...
        shadow[1].setBackgroundResource(kr.wdream.storyshop.R.drawable.header_shadow_reverse);
        ...
        pickerBottomLayout.cancelButton.setText(LocaleController.getString("Close", kr.wdream.storyshop.R.string.Close).toUpperCase());
        ...
        pickerBottomLayout.doneButtonBadgeTextView.setBackgroundResource(kr.wdream.storyshop.R.drawable.stickercounter);
        ...
        closeButton.setImageResource(kr.wdream.storyshop.R.drawable.delete_reply);
        ...
        previewSendButtonShadow.setBackgroundResource(kr.wdream.storyshop.R.drawable.header_shadow_reverse);
    ...
    private void updateSendButton() {
        ...
        if (delegate != null && (stickerSet == null || !stickerSet.set.masks)) {
            previewSendButton.setText(LocaleController.getString("SendSticker", kr.wdream.storyshop.R.string.SendSticker).toUpperCase());
            ...
            previewSendButton.setText(LocaleController.getString("Close", kr.wdream.storyshop.R.string.Close).toUpperCase());
    ...
    private void updateFields() {
        ...
        if (stickerSet != null) {
            ...
            if (stickerSet.set == null || !StickersQuery.isStickerPackInstalled(stickerSet.set.id)) {
                                        ...
                                        try {
                                            if (error == null) {
                                                if (stickerSet.set.masks) {
                                                    Toast.makeText(getContext(), LocaleController.getString("AddMasksInstalled", kr.wdream.storyshop.R.string.AddMasksInstalled), Toast.LENGTH_SHORT).show();
                                                } else {
                                                    Toast.makeText(getContext(), LocaleController.getString("AddStickersInstalled", kr.wdream.storyshop.R.string.AddStickersInstalled), Toast.LENGTH_SHORT).show();
                                                }
                                                ...
                                                Toast.makeText(getContext(), LocaleController.getString("ErrorOccurred", kr.wdream.storyshop.R.string.ErrorOccurred), Toast.LENGTH_SHORT).show();
                                            }
                                        } catch (Exception e) {
                ...
                }, stickerSet != null && stickerSet.set.masks ? LocaleController.getString("AddMasks", kr.wdream.storyshop.R.string.AddMasks) : LocaleController.getString("AddStickers", kr.wdream.storyshop.R.string.AddStickers), Theme.STICKERS_SHEET_ADD_TEXT_COLOR, true);
            } else {
                if (stickerSet.set.official) {
                    ...
                    }, LocaleController.getString("StickersRemove", kr.wdream.storyshop.R.string.StickersHide), Theme.STICKERS_SHEET_REMOVE_TEXT_COLOR, false);
                } else {
                    setRightButton(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                    ...
                    }, LocaleController.getString("StickersRemove", kr.wdream.storyshop.R.string.StickersRemove), Theme.STICKERS_SHEET_REMOVE_TEXT_COLOR, false);
                }
            }
            adapter.notifyDataSetChanged();
        } else {
