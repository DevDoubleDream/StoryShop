...
public class TimerDrawable extends Drawable {
    ...
    public TimerDrawable(Context context) {
        if (emptyTimerDrawable == null) {
            emptyTimerDrawable = context.getResources().getDrawable(kr.wdream.storyshop.R.drawable.header_timer);
            timerDrawable = context.getResources().getDrawable(kr.wdream.storyshop.R.drawable.header_timer2);
