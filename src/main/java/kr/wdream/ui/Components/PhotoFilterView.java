...
import kr.wdream.storyshop.DispatchQueue;
...
import kr.wdream.ui.Cells.PhotoEditToolCell;
...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        cancelTextView.setText(LocaleController.getString("Cancel", kr.wdream.storyshop.R.string.Cancel).toUpperCase());
        ...
        doneTextView.setText(LocaleController.getString("Done", kr.wdream.storyshop.R.string.Done).toUpperCase());
        ...
        recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (position == enhanceTool) {
                    ...
                    paramTextView.setText(LocaleController.getString("Enhance", kr.wdream.storyshop.R.string.Enhance));
                } else if (position == highlightsTool) {
                    previousValue = highlightsValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Highlights", kr.wdream.storyshop.R.string.Highlights));
                } else if (position == contrastTool) {
                    previousValue = contrastValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Contrast", kr.wdream.storyshop.R.string.Contrast));
                } else if (position == exposureTool) {
                    previousValue = exposureValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Exposure", kr.wdream.storyshop.R.string.Exposure));
                } else if (position == warmthTool) {
                    previousValue = warmthValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Warmth", kr.wdream.storyshop.R.string.Warmth));
                } else if (position == saturationTool) {
                    previousValue = saturationValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Saturation", kr.wdream.storyshop.R.string.Saturation));
                } else if (position == vignetteTool) {
                    previousValue = vignetteValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Vignette", kr.wdream.storyshop.R.string.Vignette));
                } else if (position == shadowsTool) {
                    previousValue = shadowsValue;
                    valueSeekBar.setMinMax(-100, 100);
                    paramTextView.setText(LocaleController.getString("Shadows", kr.wdream.storyshop.R.string.Shadows));
                } else if (position == grainTool) {
                    previousValue = grainValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Grain", kr.wdream.storyshop.R.string.Grain));
                } else if (position == fadeTool) {
                    previousValue = fadeValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Fade", kr.wdream.storyshop.R.string.Fade));
                } else if (position == sharpenTool) {
                    previousValue = sharpenValue;
                    valueSeekBar.setMinMax(0, 100);
                    paramTextView.setText(LocaleController.getString("Sharpen", kr.wdream.storyshop.R.string.Sharpen));
        ...
        imageView.setImageResource(kr.wdream.storyshop.R.drawable.edit_cancel);
        ...
        imageView.setImageResource(kr.wdream.storyshop.R.drawable.edit_doneblue);
        imageView.setBackgroundDrawable(Theme.createBarSelectorDrawable(Theme.ACTION_BAR_PICKER_SELECTOR_COLOR, false));
        ...
        for (int a = 0; a < 4; a++) {
            ...
            if (a == 0) {
                curveTextView[a].setText(LocaleController.getString("CurvesAll", kr.wdream.storyshop.R.string.CurvesAll).toUpperCase());
            } else if (a == 1) {
                curveTextView[a].setText(LocaleController.getString("CurvesRed", kr.wdream.storyshop.R.string.CurvesRed).toUpperCase());
            } else if (a == 2) {
                curveTextView[a].setText(LocaleController.getString("CurvesGreen", kr.wdream.storyshop.R.string.CurvesGreen).toUpperCase());
            } else if (a == 3) {
                curveTextView[a].setText(LocaleController.getString("CurvesBlue", kr.wdream.storyshop.R.string.CurvesBlue).toUpperCase());
            }
        ...
        tintShadowsButton.setText(LocaleController.getString("TintShadows", kr.wdream.storyshop.R.string.TintShadows).toUpperCase());
        ...
        tintHighlightsButton.setText(LocaleController.getString("TintHighlights", kr.wdream.storyshop.R.string.TintHighlights).toUpperCase());
        ...
        blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, kr.wdream.storyshop.R.drawable.blur_off_active, 0, 0);
        ...
        blurOffButton.setText(LocaleController.getString("BlurOff", kr.wdream.storyshop.R.string.BlurOff));
        ...
        blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, kr.wdream.storyshop.R.drawable.blur_radial, 0, 0);
        ...
        blurRadialButton.setText(LocaleController.getString("BlurRadial", kr.wdream.storyshop.R.string.BlurRadial));
        ...
        blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, kr.wdream.storyshop.R.drawable.blur_linear, 0, 0);
        ...
        blurLinearButton.setText(LocaleController.getString("BlurLinear", kr.wdream.storyshop.R.string.BlurLinear));
    ...
    private void updateSelectedBlurType() {
        if (blurType == 0) {
            ...
            blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, kr.wdream.storyshop.R.drawable.blur_off, 0, 0);
            blurOffButton.setTextColor(0xffffffff);
            blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, kr.wdream.storyshop.R.drawable.blur_radial_active, 0, 0);
            ...
            blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, kr.wdream.storyshop.R.drawable.blur_radial, 0, 0);
            blurRadialButton.setTextColor(0xffffffff);
            blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, kr.wdream.storyshop.R.drawable.blur_linear_active, 0, 0);
        ...
        if (editView.getVisibility() == GONE) {
            ...
            if (selectedTool == blurTool || selectedTool == tintTool || selectedTool == curvesTool) {
                ...
                if (selectedTool == blurTool) {
                    infoTextView.setText(LocaleController.getString("Blur", kr.wdream.storyshop.R.string.Blur));
                    if (blurType != 0) {
                        blurControl.setVisibility(VISIBLE);
                    }
                } else if (selectedTool == curvesTool) {
                    infoTextView.setText(LocaleController.getString("Curves", kr.wdream.storyshop.R.string.Curves));
                    ...
                    infoTextView.setText(LocaleController.getString("Tint", kr.wdream.storyshop.R.string.Tint));
                }
    ...
    public class ToolsAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (i == enhanceTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_enhance, LocaleController.getString("Enhance", kr.wdream.storyshop.R.string.Enhance), enhanceValue);
            } else if (i == highlightsTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_highlights, LocaleController.getString("Highlights", kr.wdream.storyshop.R.string.Highlights), highlightsValue);
            } else if (i == contrastTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_contrast, LocaleController.getString("Contrast", kr.wdream.storyshop.R.string.Contrast), contrastValue);
            } else if (i == exposureTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_brightness, LocaleController.getString("Exposure", kr.wdream.storyshop.R.string.Exposure), exposureValue);
            } else if (i == warmthTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_warmth, LocaleController.getString("Warmth", kr.wdream.storyshop.R.string.Warmth), warmthValue);
            } else if (i == saturationTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_saturation, LocaleController.getString("Saturation", kr.wdream.storyshop.R.string.Saturation), saturationValue);
            } else if (i == vignetteTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_vignette, LocaleController.getString("Vignette", kr.wdream.storyshop.R.string.Vignette), vignetteValue);
            } else if (i == shadowsTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_shadows, LocaleController.getString("Shadows", kr.wdream.storyshop.R.string.Shadows), shadowsValue);
            } else if (i == grainTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_grain, LocaleController.getString("Grain", kr.wdream.storyshop.R.string.Grain), grainValue);
            } else if (i == sharpenTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_details, LocaleController.getString("Sharpen", kr.wdream.storyshop.R.string.Sharpen), sharpenValue);
            } else if (i == tintTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_tint, LocaleController.getString("Tint", kr.wdream.storyshop.R.string.Tint), tintHighlightsColor != 0 || tintShadowsColor != 0 ? "◆" : "");
            } else if (i == fadeTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_fade, LocaleController.getString("Fade", kr.wdream.storyshop.R.string.Fade), fadeValue);
            } else if (i == curvesTool) {
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_curve, LocaleController.getString("Curves", kr.wdream.storyshop.R.string.Curves), curvesToolValue.shouldBeSkipped() ? "" : "◆");
            } else if (i == blurTool) {
                String value = "";
                if (blurType == 1) {
                    value = "R";
                ...
                ((PhotoEditToolCell) holder.itemView).setIconAndTextAndValue(kr.wdream.storyshop.R.drawable.tool_blur, LocaleController.getString("Blur", kr.wdream.storyshop.R.string.Blur), value);
            }
        }
    }
}
