...
import kr.wdream.storyshop.camera.CameraController;
...
import kr.wdream.ui.Cells.PhotoAttachCameraCell;
import kr.wdream.ui.Cells.PhotoAttachPhotoCell;
import kr.wdream.ui.Cells.ShadowSectionCell;
import kr.wdream.ui.ChatActivity;
...
import kr.wdream.storyshop.camera.CameraView;
...
public class ChatAttachAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider, BottomSheet.BottomSheetDelegateInterface {
    ...
    private class AttachButton extends FrameLayout {
        ...
        public void setTextAndIcon(CharSequence text, Drawable drawable) {
            ...
            Log.d("ChatAttachAlert", "text : " + text);
    ...
    private class AttachBotButton extends FrameLayout {
        ...
        private void onLongPress() {
            ...
            builder.setMessage(LocaleController.formatString("ChatHintsDelete", kr.wdream.storyshop.R.string.ChatHintsDelete, ContactsController.formatName(currentUser.first_name, currentUser.last_name)));
    ...
    public ChatAttachAlert(Context context, final ChatActivity parentFragment) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && getContext().checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            progressView.setText(LocaleController.getString("PermissionStorage", kr.wdream.storyshop.R.string.PermissionStorage));
            progressView.setTextSize(16);
        } else {
            progressView.setText(LocaleController.getString("NoPhotos", kr.wdream.storyshop.R.string.NoPhotos));
        ...
        CharSequence[] items = new CharSequence[]{
                LocaleController.getString("ChatCamera", kr.wdream.storyshop.R.string.ChatCamera),
                LocaleController.getString("ChatGallery", kr.wdream.storyshop.R.string.ChatGallery),
                LocaleController.getString("ChatVideo", kr.wdream.storyshop.R.string.ChatVideo),
                LocaleController.getString("AttachMusic", kr.wdream.storyshop.R.string.AttachMusic),
                LocaleController.getString("ChatDocument", kr.wdream.storyshop.R.string.ChatDocument),
                LocaleController.getString("AttachContact", kr.wdream.storyshop.R.string.AttachContact),
                LocaleController.getString("ChatLocation", kr.wdream.storyshop.R.string.ChatLocation),
                ""
        };
        for (int a = 0; a < 8; a++) {
        ...
        hintTextView.setBackgroundResource(kr.wdream.storyshop.R.drawable.tooltip);
        ...
        hintTextView.setText(LocaleController.getString("AttachBotsHelp", kr.wdream.storyshop.R.string.AttachBotsHelp));
        hintTextView.setGravity(Gravity.CENTER_VERTICAL);
        hintTextView.setVisibility(View.INVISIBLE);
        hintTextView.setCompoundDrawablesWithIntrinsicBounds(kr.wdream.storyshop.R.drawable.scroll_tip, 0, 0, 0);
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            recordTime.setBackgroundResource(kr.wdream.storyshop.R.drawable.system);
                ...
                public void onClick(View v) {
                    ...
                    animator.addListener(new AnimatorListenerAdapterProxy() {
                        ...
                        public void onAnimationEnd(Animator animator) {
                            switchCameraButton.setImageResource(cameraView.isFrontface() ? kr.wdream.storyshop.R.drawable.camera_revert1 : kr.wdream.storyshop.R.drawable.camera_revert2);
    ...
    private void setCameraFlashModeIcon(ImageView imageView, String mode) {
        switch (mode) {
            case Camera.Parameters.FLASH_MODE_OFF:
                imageView.setImageResource(kr.wdream.storyshop.R.drawable.flash_off);
                break;
            case Camera.Parameters.FLASH_MODE_ON:
                imageView.setImageResource(kr.wdream.storyshop.R.drawable.flash_on);
                break;
            case Camera.Parameters.FLASH_MODE_AUTO:
                imageView.setImageResource(kr.wdream.storyshop.R.drawable.flash_auto);
                break;
        }
    }
    ...
    public void showCamera() {
        if (cameraView == null) {
            ...
            cameraImageView.setImageResource(kr.wdream.storyshop.R.drawable.instant_camera);
    ...
    public void updatePhotosButton() {
        ...
        if (count == 0) {
            sendPhotosButton.imageView.setPadding(0, AndroidUtilities.dp(4), 0, 0);
            sendPhotosButton.imageView.setBackgroundResource(kr.wdream.storyshop.R.drawable.attach_hide_states);
            sendPhotosButton.imageView.setImageResource(kr.wdream.storyshop.R.drawable.attach_hide2);
            sendPhotosButton.textView.setText("");
        } else {
            sendPhotosButton.imageView.setPadding(AndroidUtilities.dp(2), 0, 0, 0);
            sendPhotosButton.imageView.setBackgroundResource(kr.wdream.storyshop.R.drawable.attach_send_states);
            sendPhotosButton.imageView.setImageResource(kr.wdream.storyshop.R.drawable.attach_send2);
            sendPhotosButton.textView.setText(LocaleController.formatString("SendItems", kr.wdream.storyshop.R.string.SendItems, String.format("(%d)", count)));
        }
    ...
    public void updatePhotoAtIndex(int index) {
        ...
        if (cell != null) {
            ...
            if (photoEntry.thumbPath != null) {
                cell.getImageView().setImage(photoEntry.thumbPath, null, cell.getContext().getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
            } else if (photoEntry.path != null) {
                cell.getImageView().setOrientation(photoEntry.orientation, true);
                cell.getImageView().setImage("thumb://" + photoEntry.imageId + ":" + photoEntry.path, null, cell.getContext().getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
            } else {
                cell.getImageView().setImageResource(kr.wdream.storyshop.R.drawable.nophotos);
            }
        }
    }
    ...
    private void startRevealAnimation(final boolean open) {
        ...
        if (open) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                views[a].setTag(kr.wdream.storyshop.R.string.AppName, 1);
