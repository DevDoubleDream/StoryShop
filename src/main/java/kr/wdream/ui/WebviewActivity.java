...
public class WebviewActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        progressItem = menu.addItemWithWidth(share, kr.wdream.storyshop.R.drawable.share, AndroidUtilities.dp(54));
        ...
        ActionBarMenuItem menuItem = menu.addItem(0, kr.wdream.storyshop.R.drawable.ic_ab_other);
        menuItem.addSubItem(open_in, LocaleController.getString("OpenInExternalApp", kr.wdream.storyshop.R.string.OpenInExternalApp), 0);
