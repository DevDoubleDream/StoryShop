...
public class SearchAdapter extends BaseSearchAdapter {
    ...
    private static final String LOG_TAG = "SearchAdatper";
    ...
    public SearchAdapter(Context context, HashMap<Integer, TLRPC.User> arg1, boolean usernameSearch, boolean mutual, boolean chats, boolean bots) {
        ...
        Log.d(LOG_TAG, "SearchAdapter Initiate");
    }
    ...
    public void searchDialogs(final String query) {
        ...
        Log.d("SearchAdapter", "searchDialogs Start");

        try {
            if (searchTimer != null) {
                Log.d(LOG_TAG, "searchTimer != null");
                searchTimer.cancel();
            }
        } catch (Exception e) {
    ...
    private void processSearch(final String query) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public void run() {
                ...
                Log.d(LOG_TAG, "allowUsernameSearch : " + allowUsernameSearch);
                ...
                Log.d(LOG_TAG, "contactsCopy : " + contactsCopy);
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (i == searchResult.size()) {
            if (view == null) {
                ...
                ((GreySectionCell) view).setText(LocaleController.getString("GlobalSearch", kr.wdream.storyshop.R.string.GlobalSearch));
            }
        } else {
            if (view == null) {
                if (useUserCell) {
