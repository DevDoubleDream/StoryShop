...
import kr.wdream.ui.Cells.LocationCell;
import kr.wdream.ui.Cells.LocationLoadingCell;
import kr.wdream.ui.Cells.LocationPoweredCell;
import kr.wdream.ui.Cells.SendLocationCell;

import java.util.Locale;

public class LocationActivityAdapter extends BaseLocationAdapter {

    private static final String LOG_TAG = "LocationActivityAdapter";
    ...
    private void updateCell() {
        if (sendLocationCell != null) {
            if (customLocation != null) {
                sendLocationCell.setText(LocaleController.getString("SendSelectedLocation", kr.wdream.storyshop.R.string.SendSelectedLocation), String.format(Locale.US, "(%f,%f)", customLocation.getLatitude(), customLocation.getLongitude()));
            } else {
                if (gpsLocation != null) {
                    sendLocationCell.setText(LocaleController.getString("SendLocation", kr.wdream.storyshop.R.string.SendLocation), LocaleController.formatString("AccurateTo", kr.wdream.storyshop.R.string.AccurateTo, LocaleController.formatPluralString("Meters", (int) gpsLocation.getAccuracy())));
                } else {
                    sendLocationCell.setText(LocaleController.getString("SendLocation", kr.wdream.storyshop.R.string.SendLocation), LocaleController.getString("Loading", kr.wdream.storyshop.R.string.Loading));
                }
            }
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (i == 0) {
            ...
            ((GreySectionCell) view).setText(LocaleController.getString("NearbyPlaces", kr.wdream.storyshop.R.string.NearbyPlaces));
