...
import kr.wdream.ui.Cells.HashtagSearchCell;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                ...
                view.setBackgroundResource(kr.wdream.storyshop.R.drawable.list_selector);
                break;
            case 1:
        ...
        switch (holder.getItemViewType()) {
            ...
            case 1: {
                ...
                if (isRecentSearchDisplayed()) {
                    int offset = (!SearchQuery.hints.isEmpty() ? 2 : 0);
                    if (position < offset) {
                        cell.setText(LocaleController.getString("ChatHints", kr.wdream.storyshop.R.string.ChatHints).toUpperCase());
                    } else {
                        cell.setText(LocaleController.getString("Recent", kr.wdream.storyshop.R.string.Recent).toUpperCase());
                    }
                } else if (!searchResultHashtags.isEmpty()) {
                    cell.setText(LocaleController.getString("Hashtags", kr.wdream.storyshop.R.string.Hashtags).toUpperCase());
                } else if (!globalSearch.isEmpty() && position == searchResult.size()) {
                    cell.setText(LocaleController.getString("GlobalSearch", kr.wdream.storyshop.R.string.GlobalSearch));
                } else {
                    cell.setText(LocaleController.getString("SearchMessages", kr.wdream.storyshop.R.string.SearchMessages));
                }
                break;
            }
            case 2: {
