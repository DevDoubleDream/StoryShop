...
import kr.wdream.ui.Adapters.BaseLocationAdapter;
import kr.wdream.ui.Adapters.LocationActivityAdapter;
import kr.wdream.ui.Adapters.LocationActivitySearchAdapter;
...
import kr.wdream.ui.Components.MapPlaceholderDrawable;
...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (messageObject != null) {
            if (messageObject.messageOwner.media.title != null && messageObject.messageOwner.media.title.length() > 0) {
                ...
                actionBar.setTitle(LocaleController.getString("ChatLocation", kr.wdream.storyshop.R.string.ChatLocation));
            }
            menu.addItem(share, kr.wdream.storyshop.R.drawable.share);
        } else {
            actionBar.setTitle(LocaleController.getString("ShareLocation", kr.wdream.storyshop.R.string.ShareLocation));
        ...
        ActionBarMenuItem item = menu.addItem(0, kr.wdream.storyshop.R.drawable.ic_ab_other);
        item.addSubItem(map_list_menu_map, LocaleController.getString("Map", kr.wdream.storyshop.R.string.Map), 0);
        item.addSubItem(map_list_menu_satellite, LocaleController.getString("Satellite", kr.wdream.storyshop.R.string.Satellite), 0);
        item.addSubItem(map_list_menu_hybrid, LocaleController.getString("Hybrid", kr.wdream.storyshop.R.string.Hybrid), 0);
        ...
        locationButton.setBackgroundResource(kr.wdream.storyshop.R.drawable.floating_user_states);
        locationButton.setImageResource(kr.wdream.storyshop.R.drawable.myloc_on);
        ...
        if (messageObject != null) {
            ...
            bottomView.setBackgroundResource(kr.wdream.storyshop.R.drawable.location_panel);
            ...
            routeButton.setBackgroundResource(kr.wdream.storyshop.R.drawable.floating_states);
            routeButton.setImageResource(kr.wdream.storyshop.R.drawable.navigate);
            ...
            shadow.setBackgroundResource(kr.wdream.storyshop.R.drawable.header_shadow_reverse);
            mapViewClip.addView(shadow, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 3, Gravity.LEFT | Gravity.BOTTOM));

            markerImageView = new ImageView(context);
            markerImageView.setImageResource(kr.wdream.storyshop.R.drawable.map_pin);
            ...
            markerXImageView.setImageResource(kr.wdream.storyshop.R.drawable.place_x);
    ...
    private void onMapInit() {
        ...
        if (messageObject != null) {
            LatLng latLng = new LatLng(userLocation.getLatitude(), userLocation.getLongitude());
            try {
                googleMap.addMarker(new MarkerOptions().position(latLng).icon(BitmapDescriptorFactory.fromResource(kr.wdream.storyshop.R.drawable.map_pin)));
            } catch (Exception e) {
                FileLog.e("tmessages", e);
            }
            CameraUpdate position = CameraUpdateFactory.newLatLngZoom(latLng, googleMap.getMaxZoomLevel() - 4);
    ...
    private void showPermissionAlert(boolean byButton) {
        ...
        if (byButton) {
            builder.setMessage(LocaleController.getString("PermissionNoLocationPosition", kr.wdream.storyshop.R.string.PermissionNoLocationPosition));
        } else {
            builder.setMessage(LocaleController.getString("PermissionNoLocation", kr.wdream.storyshop.R.string.PermissionNoLocation));
        }
    ...
    private void positionMarker(Location location) {
        ...
        if (messageObject != null) {
            if (userLocation != null && distanceTextView != null) {
                ...
                if (distance < 1000) {
                    distanceTextView.setText(String.format("%d %s", (int) (distance), LocaleController.getString("MetersAway", kr.wdream.storyshop.R.string.MetersAway)));
                } else {
                    distanceTextView.setText(String.format("%.2f %s", distance / 1000.0f, LocaleController.getString("KMetersAway", kr.wdream.storyshop.R.string.KMetersAway)));
                }
            }
