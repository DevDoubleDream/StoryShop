...
public class IntroActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (LocaleController.isRTL) {
            icons = new int[]{
                    ...
                    kr.wdream.storyshop.R.drawable.intro6,
                    kr.wdream.storyshop.R.drawable.intro5,
                    kr.wdream.storyshop.R.drawable.intro4,
                    kr.wdream.storyshop.R.drawable.intro3,
                    kr.wdream.storyshop.R.drawable.intro2,
                    kr.wdream.storyshop.R.drawable.intro1
            };
            titles = new int[]{
                    kr.wdream.storyshop.R.string.Page7Title,
                    kr.wdream.storyshop.R.string.Page6Title,
                    kr.wdream.storyshop.R.string.Page5Title,
                    kr.wdream.storyshop.R.string.Page4Title,
                    kr.wdream.storyshop.R.string.Page3Title,
                    kr.wdream.storyshop.R.string.Page2Title,
                    kr.wdream.storyshop.R.string.Page1Title
            };
            messages = new int[]{
                    kr.wdream.storyshop.R.string.Page7Message,
                    kr.wdream.storyshop.R.string.Page6Message,
                    kr.wdream.storyshop.R.string.Page5Message,
                    kr.wdream.storyshop.R.string.Page4Message,
                    kr.wdream.storyshop.R.string.Page3Message,
                    kr.wdream.storyshop.R.string.Page2Message,
                    kr.wdream.storyshop.R.string.Page1Message
            };
        } else {
            icons = new int[]{
                    kr.wdream.storyshop.R.drawable.intro1,
    ...
    private void initView(){
        ...
        startMessagingButton.setText(LocaleController.getString("StartMessaging", kr.wdream.storyshop.R.string.StartMessaging).toUpperCase());
            ...
            public void onPageScrollStateChanged(int i) {
                if (i == ViewPager.SCROLL_STATE_IDLE || i == ViewPager.SCROLL_STATE_SETTLING) {
                    if (lastPage != viewPager.getCurrentItem()) {
                        ...
                        Animation outAnimation = AnimationUtils.loadAnimation(IntroActivity.this, kr.wdream.storyshop.R.anim.icon_anim_fade_out);
                        ...
                        Animation inAnimation = AnimationUtils.loadAnimation(IntroActivity.this, kr.wdream.storyshop.R.anim.icon_anim_fade_in);
