...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    public void setAllowOpenDrawer(boolean value, boolean animated) {
        Log.d("DrawerLayoutContainer", "setAllowOpenDrwer");
        allowOpenDrawer = value;
        if (!allowOpenDrawer && drawerPosition != 0) {
            Log.d("DrawaerLayoutContainer", "allowOpenDrawer ! drawerPosition != 0");
            if (!animated) {
                Log.d("DrawerLayoutContainer", "이게뭘까");
                setDrawerPosition(0);
                onDrawerAnimationEnd(false);
            } else {
                closeDrawer(true);
                Log.d("DrawerLayoutContainer", "closeDrawer true");
            }
        }
    }
