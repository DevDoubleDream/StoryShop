...
public class ActionBarMenuItem extends FrameLayout {
    ...
    private static final String LOG_TAG = "ActionBarMenuItem";
    ...
    public TextView addSubItem(int id, String text, int icon) {
        ...
        textView.setBackgroundResource(kr.wdream.storyshop.R.drawable.list_selector);
    ...
    public void toggleSubMenu() {
        if (popupLayout == null) {
            Log.d(LOG_TAG, "popupLayout is null");
            return;
        }
        if (showMenuRunnable != null) {
            Log.d(LOG_TAG, "showMenuRunnable is not null");
            AndroidUtilities.cancelRunOnUIThread(showMenuRunnable);
            showMenuRunnable = null;
        }
        if (popupWindow != null && popupWindow.isShowing()) {
            Log.d(LOG_TAG, "popupWindow != null && popupWindow.isShowing()");
            popupWindow.dismiss();
            return;
        }
        if (popupWindow == null) {
            Log.d(LOG_TAG, "popupWindow is null");
            popupWindow = new ActionBarPopupWindow(popupLayout, LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT);
            if (Build.VERSION.SDK_INT >= 19) {
                popupWindow.setAnimationStyle(0);
            } else {
                popupWindow.setAnimationStyle(kr.wdream.storyshop.R.style.PopupAnimation);
            }
    ...
    public ActionBarMenuItem setIsSearchField(boolean value) {
        ...
        if (value && searchContainer == null) {
            ...
            try {
                ...
                mCursorDrawableRes.set(searchField, kr.wdream.storyshop.R.drawable.search_carret);
            } catch (Exception e) {
                //nothing to do
            }
            ...
            clearButton.setImageResource(kr.wdream.storyshop.R.drawable.ic_close_white);
