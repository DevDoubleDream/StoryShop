...
public class ActionBar extends FrameLayout {
    ...
    private void createBackButtonImage() {
        Log.d(LOG_TAG, "createBackButtonImage");
        ...
        backButtonImageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (isSearchFieldVisible) {
                    Log.d(LOG_TAG, "backButton Click");
                    closeSearchField();
                    return;
                }
    ...
    public void setBackButtonDrawable(Drawable drawable) {
        Log.d(LOG_TAG, "setBackButtonDrawable");
        if (backButtonImageView == null) {
    ...
    public void setBackButtonImage(int resource) {
        Log.d(LOG_TAG, "setBackButtonImage");
        if (backButtonImageView == null) {
            createBackButtonImage();
        }
    ...
    private void createSubtitleTextView() {
        Log.d(LOG_TAG, "createSubtitleTextView");
    ...
    public void setAddToContainer(boolean value) {
        Log.d(LOG_TAG, "setAddToContainer");
        addToContainer = value;
    }

    public boolean getAddToContainer() {
        Log.d(LOG_TAG, "getAddToContainer : " + addToContainer);
        return addToContainer;
    }

    public void setSubtitle(CharSequence value) {
        Log.d(LOG_TAG, "setSubTitle");
    ...
    private void createTitleTextView() {
        Log.d(LOG_TAG, "createTitleTextView");
    ...
    public void setSubtitleColor(int color) {
        Log.d(LOG_TAG, "setSubTitleColor");
        if (subtitleTextView == null) {
            createSubtitleTextView();
        }
    ...
    public SimpleTextView getSubtitleTextView() {
        Log.d(LOG_TAG, "getSubTitleTextView");
        return subtitleTextView;
    }

    public SimpleTextView getTitleTextView() {
        Log.d(LOG_TAG, "getTitleTextView");
    ...
    public void setActionBarMenuOnItemClick(ActionBarMenuOnItemClick listener) {
        Log.d(LOG_TAG, "setActionBarMenuOnItemClick");
        actionBarMenuOnItemClick = listener;
    }

    public ActionBarMenu createActionMode() {
        Log.d(LOG_TAG, "createActionMode");
        if (actionMode != null) {
            return actionMode;
        }
    ...
    public void showActionModeTop() {
        Log.d(LOG_TAG, "showActionModeTop");
        if (occupyStatusBar && actionModeTop == null) {
            actionModeTop = new View(getContext());
            actionModeTop.setBackgroundColor(0x99000000);
            addView(actionModeTop);
