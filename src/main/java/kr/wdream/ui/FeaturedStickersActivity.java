...
import kr.wdream.ui.Cells.FeaturedStickerSetCell;
...
public class FeaturedStickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static final String LOG_TAG = "FeaturedStickersActivity";
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("FeaturedStickers", kr.wdream.storyshop.R.string.FeaturedStickers));
