...
import kr.wdream.storyshop.volley.AuthFailureError;
import kr.wdream.storyshop.volley.Request;
import kr.wdream.storyshop.volley.RequestQueue;
import kr.wdream.storyshop.volley.Response;
import kr.wdream.storyshop.volley.VolleyError;
import kr.wdream.storyshop.volley.toolbox.JsonObjectRequest;
import kr.wdream.storyshop.volley.toolbox.Volley;
...
import kr.wdream.ui.Cells.PhotoPickerPhotoCell;
import kr.wdream.ui.Components.BackupImageView;
import kr.wdream.ui.Components.LayoutHelper;
import kr.wdream.ui.Components.PickerBottomLayout;
...
public class PhotoPickerActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    private static final String LOG_TAG = "PhotoPickerActivity";
    ...
    public View createView(Context context) {
        ...
        if (selectedAlbum != null) {
            ...
            actionBar.setTitle(LocaleController.getString("SearchImagesTitle", kr.wdream.storyshop.R.string.SearchImagesTitle));
        } else if (type == 1) {
            actionBar.setTitle(LocaleController.getString("SearchGifsTitle", kr.wdream.storyshop.R.string.SearchGifsTitle));
        }
            ...
            searchItem = menu.addItem(0, kr.wdream.storyshop.R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
                ...
                public void onTextChanged(EditText editText) {
                    if (editText.getText().length() == 0) {
                        ...
                        requestQueue.cancelAll("search");
                        if (type == 0) {
                            emptyView.setText(LocaleController.getString("NoRecentPhotos", kr.wdream.storyshop.R.string.NoRecentPhotos));
                        } else if (type == 1) {
                            emptyView.setText(LocaleController.getString("NoRecentGIFs", kr.wdream.storyshop.R.string.NoRecentGIFs));
                        }
                ...
                public void onSearchPressed(EditText editText) {
                    ...
                    if (lastSearchString.length() == 0) {
                        ...
                        emptyView.setText(LocaleController.getString("NoResult", kr.wdream.storyshop.R.string.NoResult));
                    }
                    updateSearchInterface();
                }
            });
        ...
        if (selectedAlbum == null) {
            if (type == 0) {
                searchItem.getSearchField().setHint(LocaleController.getString("SearchImagesTitle", kr.wdream.storyshop.R.string.SearchImagesTitle));
            } else if (type == 1) {
                searchItem.getSearchField().setHint(LocaleController.getString("SearchGifsTitle", kr.wdream.storyshop.R.string.SearchGifsTitle));
            }
        }
        ...
        listView.setSelector(kr.wdream.storyshop.R.drawable.list_selector);
        ...
        if (selectedAlbum != null) {
            emptyView.setText(LocaleController.getString("NoPhotos", kr.wdream.storyshop.R.string.NoPhotos));
        } else {
            if (type == 0) {
                emptyView.setText(LocaleController.getString("NoRecentPhotos", kr.wdream.storyshop.R.string.NoRecentPhotos));
            } else if (type == 1) {
        ...
        if (cell != null) {
            if (selectedAlbum != null) {
                ...
                if (photoEntry.thumbPath != null) {
                    cell.photoImage.setImage(photoEntry.thumbPath, null, cell.getContext().getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                } else if (photoEntry.path != null) {
                    cell.photoImage.setOrientation(photoEntry.orientation, true);
                    if (photoEntry.isVideo) {
                        cell.photoImage.setImage("vthumb://" + photoEntry.imageId + ":" + photoEntry.path, null, cell.getContext().getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                    } else {
                        cell.photoImage.setImage("thumb://" + photoEntry.imageId + ":" + photoEntry.path, null, cell.getContext().getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                    }
                } else {
                    cell.photoImage.setImageResource(kr.wdream.storyshop.R.drawable.nophotos);
                }
            } else {
                ArrayList<MediaController.SearchImage> array;
                if (searchResult.isEmpty() && lastSearchString == null) {
                ...
                if (photoEntry.document != null && photoEntry.document.thumb != null) {
                    cell.photoImage.setImage(photoEntry.document.thumb.location, null, cell.getContext().getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                } else if (photoEntry.thumbPath != null) {
                    cell.photoImage.setImage(photoEntry.thumbPath, null, cell.getContext().getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                } else if (photoEntry.thumbUrl != null && photoEntry.thumbUrl.length() > 0) {
                    cell.photoImage.setImage(photoEntry.thumbUrl, null, cell.getContext().getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                } else {
                    cell.photoImage.setImageResource(kr.wdream.storyshop.R.drawable.nophotos);
                }
            }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (viewType == 0) {
                ...
                if (selectedAlbum != null) {
                    ...
                    if (photoEntry.thumbPath != null) {
                        imageView.setImage(photoEntry.thumbPath, null, mContext.getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                    } else if (photoEntry.path != null) {
                        imageView.setOrientation(photoEntry.orientation, true);
                        if (photoEntry.isVideo) {
                            imageView.setImage("vthumb://" + photoEntry.imageId + ":" + photoEntry.path, null, mContext.getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                        } else {
                            imageView.setImage("thumb://" + photoEntry.imageId + ":" + photoEntry.path, null, mContext.getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                        }
                    } else {
                        imageView.setImageResource(kr.wdream.storyshop.R.drawable.nophotos);
                    }
                    ...
                    if (photoEntry.thumbPath != null) {
                        ...
                        imageView.setImage(photoEntry.thumbUrl, null, mContext.getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                    } else if (photoEntry.document != null && photoEntry.document.thumb != null) {
                        imageView.setImage(photoEntry.document.thumb.location, null, mContext.getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                    } else {
                        imageView.setImageResource(kr.wdream.storyshop.R.drawable.nophotos);
                    }
                ...
                if (view == null) {
                    ...
                    view = li.inflate(kr.wdream.storyshop.R.layout.media_loading_layout, viewGroup, false);
                }
