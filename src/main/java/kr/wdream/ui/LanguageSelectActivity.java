...
public class LanguageSelectActivity extends BaseFragment {
    ...
    private static final String LOG_TAG = "LanguageSelectActivity";
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("Language", kr.wdream.storyshop.R.string.Language));
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                builder.setMessage(LocaleController.getString("DeleteLocalization", kr.wdream.storyshop.R.string.DeleteLocalization));
                builder.setTitle(LocaleController.getString("AppName", kr.wdream.storyshop.R.string.AppName));
                builder.setPositiveButton(LocaleController.getString("Delete", kr.wdream.storyshop.R.string.Delete), new DialogInterface.OnClickListener() {
                    @Override
