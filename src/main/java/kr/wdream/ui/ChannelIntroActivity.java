...
public class ChannelIntroActivity extends BaseFragment {
    ...
    private static final String LOG_TAG = "ChannelIntroActivity";
    ...
    public View createView(Context context) {
        ...
        imageView.setImageResource(kr.wdream.storyshop.R.drawable.channelintro);
        ...
        whatIsChannelText.setText(LocaleController.getString("ChannelAlertTitle", kr.wdream.storyshop.R.string.ChannelAlertTitle));
        ...
        descriptionText.setText(LocaleController.getString("ChannelAlertText", kr.wdream.storyshop.R.string.ChannelAlertText));
        ...
        createChannelText.setText(LocaleController.getString("ChannelAlertCreate", kr.wdream.storyshop.R.string.ChannelAlertCreate));
