...
public class SharedPhotoVideoCell extends FrameLayout {
    ...
    private class PhotoVideoView extends FrameLayout {
        ...
        public PhotoVideoView(Context context) {
            ...
            videoInfoContainer.setBackgroundResource(kr.wdream.storyshop.R.drawable.phototime);
            ...
            imageView1.setImageResource(kr.wdream.storyshop.R.drawable.ic_video);
            ...
            selector.setBackgroundResource(kr.wdream.storyshop.R.drawable.list_selector);
            addView(selector, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT));

            checkBox = new CheckBox(context, kr.wdream.storyshop.R.drawable.round_check2);
        ...
        if (messageObject != null) {
            ...
            if (messageObject.isVideo()) {
                ...
                if (messageObject.getDocument().thumb != null) {
                    ...
                    photoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(kr.wdream.storyshop.R.drawable.photo_placeholder_in), null, location, "b", null, 0);
                } else {
                    photoVideoView.imageView.setImageResource(kr.wdream.storyshop.R.drawable.photo_placeholder_in);
                }
                ...
                photoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(kr.wdream.storyshop.R.drawable.photo_placeholder_in), null, photoSize.location, "b", null, 0);
            } else {
                photoVideoView.videoInfoContainer.setVisibility(INVISIBLE);
                photoVideoView.imageView.setImageResource(kr.wdream.storyshop.R.drawable.photo_placeholder_in);
            }
