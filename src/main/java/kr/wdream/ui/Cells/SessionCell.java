...
public class SessionCell extends FrameLayout {
    ...
    public void setSession(TLRPC.TL_authorization session, boolean divider) {
        ...
        if ((session.flags & 1) != 0) {
            onlineTextView.setText(LocaleController.getString("Online", kr.wdream.storyshop.R.string.Online));
        ...
        if ((session.flags & 2) == 0) {
            ...
            stringBuilder.append(LocaleController.getString("UnofficialApp", kr.wdream.storyshop.R.string.UnofficialApp));
