...
public class SharedDocumentCell extends FrameLayout implements MediaController.FileDownloadProgressListener {
    ...
    private int icons[] = {
            kr.wdream.storyshop.R.drawable.media_doc_blue,
            kr.wdream.storyshop.R.drawable.media_doc_green,
            kr.wdream.storyshop.R.drawable.media_doc_red,
            kr.wdream.storyshop.R.drawable.media_doc_yellow
    };
    ...
    public void setDocument(MessageObject messageObject, boolean divider) {
        ...
        if (messageObject != null && messageObject.getDocument() != null) {
            ...
            dateTextView.setText(String.format("%s, %s", AndroidUtilities.formatFileSize(messageObject.getDocument().size), LocaleController.formatString("formatDateAtTime", kr.wdream.storyshop.R.string.formatDateAtTime, LocaleController.getInstance().formatterYear.format(new Date(date)), LocaleController.getInstance().formatterDay.format(new Date(date)))));
        } else {
    ...
    public void updateFileExistIcon() {
        if (message != null && message.messageOwner.media != null) {
            ...
            if (fileName == null) {
                ...
                statusImageView.setImageResource(loading ? kr.wdream.storyshop.R.drawable.media_doc_pause : kr.wdream.storyshop.R.drawable.media_doc_load);
