...
public class AboutLinkCell extends FrameLayout {
    ...
    private static final String LOG_TAG = "AboutLinkCell";
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Toast.makeText(getContext().getApplicationContext(), "onTouchEventStart", Toast.LENGTH_SHORT).show();
