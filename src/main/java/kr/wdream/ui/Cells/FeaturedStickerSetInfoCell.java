    ...
    public void setStickerSet(TLRPC.StickerSetCovered stickerSet, boolean unread) {
        ...
        if (hasOnClick) {
            ...
            if (isInstalled = StickersQuery.isStickerPackInstalled(stickerSet.set.id)) {
                addButton.setBackgroundResource(kr.wdream.storyshop.R.drawable.del_states);
                addButton.setText(LocaleController.getString("StickersRemove", kr.wdream.storyshop.R.string.StickersRemove).toUpperCase());
            } else {
                addButton.setBackgroundResource(kr.wdream.storyshop.R.drawable.add_states);
                addButton.setText(LocaleController.getString("Add", kr.wdream.storyshop.R.string.Add).toUpperCase());
            }
        } else {
