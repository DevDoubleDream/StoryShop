...
public class ProfileSearchCell extends BaseCell {
    ...
    public ProfileSearchCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            checkDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.check_list);
    ...
    public void buildLayout() {
        ...
        if (chat == null || subLabel != null) {
            ...
            if (subLabel != null) {
                ...
                if (user.bot) {
                    onlineString = LocaleController.getString("Bot", kr.wdream.storyshop.R.string.Bot);
                } else {
                    ...
                    if (user != null && (user.id == UserConfig.getClientUserId() || user.status != null && user.status.expires > ConnectionsManager.getInstance().getCurrentTime())) {
                        ...
                        onlineString = LocaleController.getString("Online", kr.wdream.storyshop.R.string.Online);
                    }
                }
            }
