...
public class DialogCell extends BaseCell {
    ...
    public DialogCell(Context context) {
        ...
        if (namePaint == null) {
            ...
            lockDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.list_secret);
            checkDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.dialogs_check);
            halfCheckDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.dialogs_halfcheck);
            clockDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.msg_clock);
            errorDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.dialogs_warning);
            countDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.dialogs_badge);
            countDrawableGrey = getResources().getDrawable(kr.wdream.storyshop.R.drawable.dialogs_badge2);
            groupDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.list_group);
            broadcastDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.list_broadcast);
            muteDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.mute_grey);
            verifiedDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.check_list);
            botDrawable = getResources().getDrawable(kr.wdream.storyshop.R.drawable.bot_list);
        }
        ...
        setBackgroundResource(kr.wdream.storyshop.R.drawable.list_selector);
    ...
    public void buildLayout() {
        ...
        if (printingString != null) {
            ...
            if (draftMessage != null) {
                ...
                if (TextUtils.isEmpty(draftMessage.message)) {
                    String draftString = LocaleController.getString("Draft", kr.wdream.storyshop.R.string.Draft);
                ...
                if (message == null) {
                    if (encryptedChat != null) {
                        ...
                        if (encryptedChat instanceof TLRPC.TL_encryptedChatRequested) {
                            messageString = LocaleController.getString("EncryptionProcessing", kr.wdream.storyshop.R.string.EncryptionProcessing);
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChatWaiting) {
                            if (user != null && user.first_name != null) {
                                messageString = LocaleController.formatString("AwaitingEncryption", kr.wdream.storyshop.R.string.AwaitingEncryption, user.first_name);
                            } else {
                                messageString = LocaleController.formatString("AwaitingEncryption", kr.wdream.storyshop.R.string.AwaitingEncryption, "");
                            }
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChatDiscarded) {
                            messageString = LocaleController.getString("EncryptionRejected", kr.wdream.storyshop.R.string.EncryptionRejected);
                        } else if (encryptedChat instanceof TLRPC.TL_encryptedChat) {
                            if (encryptedChat.admin_id == UserConfig.getClientUserId()) {
                                if (user != null && user.first_name != null) {
                                    messageString = LocaleController.formatString("EncryptedChatStartedOutgoing", kr.wdream.storyshop.R.string.EncryptedChatStartedOutgoing, user.first_name);
                                } else {
                                    messageString = LocaleController.formatString("EncryptedChatStartedOutgoing", kr.wdream.storyshop.R.string.EncryptedChatStartedOutgoing, "");
                                }
                            } else {
                                messageString = LocaleController.getString("EncryptedChatStartedIncoming", kr.wdream.storyshop.R.string.EncryptedChatStartedIncoming);
                            }
                        }
                    }
                } else {
                    ...
                    if (message.messageOwner instanceof TLRPC.TL_messageService) {
                        ...
                        if (chat != null && chat.id > 0 && fromChat == null) {
                            ...
                            if (message.isOutOwner()) {
                                name = LocaleController.getString("FromYou", kr.wdream.storyshop.R.string.FromYou);
        ...
        if (chat != null) {
            ...
            if (user.id == UserConfig.getClientUserId()) {
                nameString = LocaleController.getString("ChatYourSelfName", kr.wdream.storyshop.R.string.ChatYourSelfName);
        ...
        if (nameString.length() == 0) {
            nameString = LocaleController.getString("HiddenName", kr.wdream.storyshop.R.string.HiddenName);
        }
