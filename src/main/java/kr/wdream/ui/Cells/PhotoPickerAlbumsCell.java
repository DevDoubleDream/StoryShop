        ...
        if (albumEntry != null) {
            ...
            if (albumEntry.coverPhoto != null && albumEntry.coverPhoto.path != null) {
                ...
                if (albumEntry.coverPhoto.isVideo) {
                    albumView.imageView.setImage("vthumb://" + albumEntry.coverPhoto.imageId + ":" + albumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                } else {
                    albumView.imageView.setImage("thumb://" + albumEntry.coverPhoto.imageId + ":" + albumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(kr.wdream.storyshop.R.drawable.nophotos));
                }
            } else {
                albumView.imageView.setImageResource(kr.wdream.storyshop.R.drawable.nophotos);
            }
