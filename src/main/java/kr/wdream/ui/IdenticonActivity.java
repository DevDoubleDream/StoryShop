...
public class IdenticonActivity extends BaseFragment {
    private static final String LOG_TAG = "IdentionActivity";
    private int chat_id;
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("EncryptionKey", kr.wdream.storyshop.R.string.EncryptionKey));
        ...
        if (encryptedChat != null) {
            ...
            hash.append(AndroidUtilities.replaceTags(LocaleController.formatString("EncryptionKeyDescription", kr.wdream.storyshop.R.string.EncryptionKeyDescription, user.first_name, user.first_name)));
            final String url = "telegram.org";
            int index = hash.toString().indexOf(url);
            if (index != -1) {
                hash.setSpan(new URLSpanReplacement(LocaleController.getString("EncryptionKeyLink", kr.wdream.storyshop.R.string.EncryptionKeyLink)), index, index + url.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
