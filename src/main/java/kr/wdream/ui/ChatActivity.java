...
import kr.wdream.storyshop.BuildConfig;
import kr.wdream.storyshop.ChatObject;
import kr.wdream.storyshop.Emoji;
import kr.wdream.storyshop.LocaleController;
import kr.wdream.storyshop.MediaController;
import kr.wdream.storyshop.MessagesStorage;
import kr.wdream.storyshop.NotificationsController;
import kr.wdream.storyshop.SecretChatHelper;
import kr.wdream.storyshop.SendMessagesHelper;
import kr.wdream.storyshop.UserObject;
import kr.wdream.storyshop.Utilities;
import kr.wdream.storyshop.VideoEditedInfo;
import kr.wdream.storyshop.browser.Browser;
import kr.wdream.storyshop.query.BotQuery;
import kr.wdream.storyshop.query.DraftQuery;
import kr.wdream.storyshop.query.MessagesSearchQuery;
import kr.wdream.storyshop.query.MessagesQuery;
import kr.wdream.storyshop.query.SearchQuery;
import kr.wdream.storyshop.query.StickersQuery;
import kr.wdream.storyshop.support.widget.GridLayoutManager;
...
import kr.wdream.ui.ActionBar.ActionBarLayout;
import kr.wdream.ui.ActionBar.BackDrawable;
import kr.wdream.ui.ActionBar.BottomSheet;
import kr.wdream.ui.ActionBar.SimpleTextView;
import kr.wdream.ui.Adapters.MentionsAdapter;
import kr.wdream.ui.Adapters.StickersAdapter;
import kr.wdream.storyshop.AnimatorListenerAdapterProxy;
import kr.wdream.ui.Cells.ChatActionCell;
import kr.wdream.ui.Cells.ChatLoadingCell;
...
import kr.wdream.ui.Cells.ChatMessageCell;
import kr.wdream.ui.Cells.ChatUnreadCell;
import kr.wdream.ui.Cells.CheckBoxCell;
import kr.wdream.ui.Cells.ContextLinkCell;
import kr.wdream.ui.Components.AlertsCreator;
import kr.wdream.ui.Components.BackupImageView;
import kr.wdream.ui.ActionBar.BaseFragment;
import kr.wdream.ui.Cells.BotHelpCell;
import kr.wdream.ui.Components.ChatActivityEnterView;
import kr.wdream.storyshop.ImageReceiver;
import kr.wdream.ui.Components.ChatAttachAlert;
import kr.wdream.ui.Components.ChatAvatarContainer;
import kr.wdream.ui.Components.ChatBigEmptyView;
import kr.wdream.ui.Components.ContextProgressView;
import kr.wdream.ui.Components.ExtendedGridLayoutManager;
import kr.wdream.ui.Components.PlayerView;
import kr.wdream.ui.Components.LayoutHelper;
import kr.wdream.ui.Components.NumberTextView;
import kr.wdream.ui.Components.RecyclerListView;
import kr.wdream.ui.Components.ShareAlert;
import kr.wdream.ui.Components.Size;
import kr.wdream.ui.Components.SizeNotifierFrameLayout;
import kr.wdream.ui.Components.StickersAlert;
import kr.wdream.ui.ActionBar.Theme;
import kr.wdream.ui.Components.URLSpanBotCommand;
import kr.wdream.ui.Components.URLSpanNoUnderline;
import kr.wdream.ui.Components.URLSpanReplacement;
import kr.wdream.ui.Components.URLSpanUserMention;
import kr.wdream.ui.Components.WebFrameLayout;
...
public class ChatActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate,
    ...
    public View createView(Context context) {
        ...
        if (currentEncryptedChat == null && !isBroadcast) {
            searchItem = menu.addItem(0, kr.wdream.storyshop.R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
            ...
            searchItem.getSearchField().setHint(LocaleController.getString("Search", kr.wdream.storyshop.R.string.Search));
            searchItem.setVisibility(View.GONE);
        }

        headerItem = menu.addItem(0, kr.wdream.storyshop.R.drawable.ic_ab_other);
        if (searchItem != null) {
            headerItem.addSubItem(search, LocaleController.getString("Search", kr.wdream.storyshop.R.string.Search), 0);
        }
        if (ChatObject.isChannel(currentChat) && !currentChat.creator && (!currentChat.megagroup || currentChat.username != null && currentChat.username.length() > 0)) {
            headerItem.addSubItem(report, LocaleController.getString("ReportChat", kr.wdream.storyshop.R.string.ReportChat), 0);
        }
        if (currentUser != null) {
            addContactItem = headerItem.addSubItem(share_contact, "", 0);
        }
        if (currentEncryptedChat != null) {
            timeItem2 = headerItem.addSubItem(chat_enc_timer, LocaleController.getString("SetTimer", kr.wdream.storyshop.R.string.SetTimer), 0);
        }
        if (!ChatObject.isChannel(currentChat)) {
            headerItem.addSubItem(clear_history, LocaleController.getString("ClearHistory", kr.wdream.storyshop.R.string.ClearHistory), 0);
            if (currentChat != null && !isBroadcast) {
                headerItem.addSubItem(delete_chat, LocaleController.getString("DeleteAndExit", kr.wdream.storyshop.R.string.DeleteAndExit), 0);
            } else {
                headerItem.addSubItem(delete_chat, LocaleController.getString("DeleteChatUser", kr.wdream.storyshop.R.string.DeleteChatUser), 0);
            }
        }
        ...
        if (currentUser != null && currentEncryptedChat == null && currentUser.bot) {
            headerItem.addSubItem(bot_settings, LocaleController.getString("BotSettings", kr.wdream.storyshop.R.string.BotSettings), 0);
            headerItem.addSubItem(bot_help, LocaleController.getString("BotHelp", kr.wdream.storyshop.R.string.BotHelp), 0);
            updateBotButtons();
        }
        ...
        attachItem = menu.addItem(chat_menu_attach, kr.wdream.storyshop.R.drawable.ic_ab_other).setOverrideMenuClick(true).setAllowCloseAnimation(false);
        attachItem.setVisibility(View.GONE);
        menuItem = menu.addItem(chat_menu_attach, kr.wdream.storyshop.R.drawable.ic_ab_attach).setAllowCloseAnimation(false);
        ...
        if (currentEncryptedChat == null) {
            if (!isBroadcast) {
                actionModeViews.add(actionMode.addItem(reply, kr.wdream.storyshop.R.drawable.ic_ab_reply, Theme.ACTION_BAR_MODE_SELECTOR_COLOR, null, AndroidUtilities.dp(54)));
            }
            actionModeViews.add(actionMode.addItem(copy, kr.wdream.storyshop.R.drawable.ic_ab_fwd_copy, Theme.ACTION_BAR_MODE_SELECTOR_COLOR, null, AndroidUtilities.dp(54)));
            actionModeViews.add(actionMode.addItem(forward, kr.wdream.storyshop.R.drawable.ic_ab_fwd_forward, Theme.ACTION_BAR_MODE_SELECTOR_COLOR, null, AndroidUtilities.dp(54)));
            actionModeViews.add(actionMode.addItem(delete, kr.wdream.storyshop.R.drawable.ic_ab_fwd_delete, Theme.ACTION_BAR_MODE_SELECTOR_COLOR, null, AndroidUtilities.dp(54)));
            actionModeViews.add(editDoneItem = actionMode.addItem(edit_done, kr.wdream.storyshop.R.drawable.check_blue, Theme.ACTION_BAR_MODE_SELECTOR_COLOR, null, AndroidUtilities.dp(54)));
        ...
        if (currentEncryptedChat == null) {
            if (currentUser != null && currentUser.self) {
                ...
                if (currentUser != null && currentUser.id != 777000 && currentUser.id != 429000 && (currentUser.id / 1000 == 333 || currentUser.id % 1000 == 0)) {
                    emptyView.setText(LocaleController.getString("GotAQuestion", kr.wdream.storyshop.R.string.GotAQuestion));
                } else {
                    emptyView.setText(LocaleController.getString("NoMessages", kr.wdream.storyshop.R.string.NoMessages));
                }
            ...
            if (currentEncryptedChat.admin_id == UserConfig.getClientUserId()) {
                bigEmptyView.setSecretText(LocaleController.formatString("EncryptedPlaceholderTitleOutgoing", kr.wdream.storyshop.R.string.EncryptedPlaceholderTitleOutgoing, UserObject.getFirstName(currentUser)));
            } else {
                bigEmptyView.setSecretText(LocaleController.formatString("EncryptedPlaceholderTitleIncoming", kr.wdream.storyshop.R.string.EncryptedPlaceholderTitleIncoming, UserObject.getFirstName(currentUser)));
            }
            emptyViewContainer.addView(bigEmptyView, new FrameLayout.LayoutParams(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.CENTER));
        }
                ...
                if (openSecretPhotoRunnable != null || SecretPhotoViewer.getInstance().isVisible()) {
                    if (event.getAction() == MotionEvent.ACTION_UP || event.getAction() == MotionEvent.ACTION_CANCEL || event.getAction() == MotionEvent.ACTION_POINTER_UP) {
                        ...
                        if (openSecretPhotoRunnable != null) {
                            ...
                            try {
                                Toast.makeText(v.getContext(), LocaleController.getString("PhotoTip", kr.wdream.storyshop.R.string.PhotoTip), Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                                FileLog.e("tmessages", e);
                            }
        ...
        try {
            progressBar.setIndeterminateDrawable(context.getResources().getDrawable(kr.wdream.storyshop.R.drawable.loading_animation));
        } catch (Exception e) {
            //don't promt
        }
        ...
        addToContactsButton.setText(LocaleController.getString("AddContactChat", kr.wdream.storyshop.R.string.AddContactChat));
        ...
        if (currentChat != null) {
            reportSpamButton.setText(LocaleController.getString("ReportSpamAndLeave", kr.wdream.storyshop.R.string.ReportSpamAndLeave));
        } else {
            reportSpamButton.setText(LocaleController.getString("ReportSpam", kr.wdream.storyshop.R.string.ReportSpam));
        }
        ...
        reportSpamButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ChatObject.isChannel(currentChat) && !currentChat.megagroup) {
                    builder.setMessage(LocaleController.getString("ReportSpamAlertChannel", kr.wdream.storyshop.R.string.ReportSpamAlertChannel));
                } else if (currentChat != null) {
                    builder.setMessage(LocaleController.getString("ReportSpamAlertGroup", kr.wdream.storyshop.R.string.ReportSpamAlertGroup));
                } else {
                    builder.setMessage(LocaleController.getString("ReportSpamAlert", kr.wdream.storyshop.R.string.ReportSpamAlert));
                }
                builder.setTitle(LocaleController.getString("AppName", kr.wdream.storyshop.R.string.AppName));
                builder.setPositiveButton(LocaleController.getString("OK", kr.wdream.storyshop.R.string.OK), new DialogInterface.OnClickListener() {
                    @Override
                        ...
                        if (allowStickersPanel && (!mentionsAdapter.isBotContext() || (allowContextBotPanel || allowContextBotPanelSecond))) {
                            if (currentEncryptedChat != null && mentionsAdapter.isBotContext()) {
                                ...
                                if (!preferences.getBoolean("secretbot", false)) {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                                    builder.setTitle(LocaleController.getString("AppName", kr.wdream.storyshop.R.string.AppName));
                                    builder.setMessage(LocaleController.getString("SecretChatContextBotAlert", kr.wdream.storyshop.R.string.SecretChatContextBotAlert));
            ...
            public void onClick(View view) {
                ...
                if (currentUser != null && userBlocked) {
                    if (currentUser.bot) {
                        ...
                        builder.setMessage(LocaleController.getString("AreYouSureUnblockContact", kr.wdream.storyshop.R.string.AreYouSureUnblockContact));
                        builder.setPositiveButton(LocaleController.getString("OK", kr.wdream.storyshop.R.string.OK), new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                MessagesController.getInstance().unblockUser(currentUser.id);
    ...
    public void shareMyContact(final MessageObject messageObject) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setTitle(LocaleController.getString("ShareYouPhoneNumberTitle", kr.wdream.storyshop.R.string.ShareYouPhoneNumberTitle));
        if (currentUser != null) {
            if (currentUser.bot) {
                builder.setMessage(LocaleController.getString("AreYouSureShareMyContactInfoBot", kr.wdream.storyshop.R.string.AreYouSureShareMyContactInfoBot));
            } else {
                builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AreYouSureShareMyContactInfoUser", kr.wdream.storyshop.R.string.AreYouSureShareMyContactInfoUser, PhoneFormat.getInstance().format("+" + UserConfig.getCurrentUser().phone), ContactsController.formatName(currentUser.first_name, currentUser.last_name))));
            }
        } else {
            builder.setMessage(LocaleController.getString("AreYouSureShareMyContactInfo", kr.wdream.storyshop.R.string.AreYouSureShareMyContactInfo));
        }
        builder.setPositiveButton(LocaleController.getString("OK", kr.wdream.storyshop.R.string.OK), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void showGifHint() {
        ...
        gifHintTextView.setText(LocaleController.getString("TapHereGifs", kr.wdream.storyshop.R.string.TapHereGifs));
                ...
                if (currentEncryptedChat != null && MessagesController.getInstance().secretWebpagePreview == 2) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            builder.setNegativeButton(LocaleController.getString("Cancel", kr.wdream.storyshop.R.string.Cancel), null);
                            builder.setMessage(LocaleController.getString("SecretLinkPreviewAlert", kr.wdream.storyshop.R.string.SecretLinkPreviewAlert));
                            showDialog(builder.create());
    ...
    public void showReplyPanel(boolean show, MessageObject messageObjectToReply, ArrayList<MessageObject> messageObjectsToForward, TLRPC.WebPage webPage, boolean cancel, boolean animated) {
        ...
        if (show) {
            ...
            if (messageObjectToReply != null) {
                ...
                replyIconImageView.setImageResource(kr.wdream.storyshop.R.drawable.reply);
                ...
                replyIconImageView.setImageResource(kr.wdream.storyshop.R.drawable.forward_blue);
                ...
                if (type == -1 || type == 0 || type == 10 || type == 11) {
                    ...
                    if (type == 1) {
                        ...
                        if (messageObjectsToForward.size() == 1) {
                            if (type == 8) {
                                replyObjectTextView.setText(LocaleController.getString("AttachGif", kr.wdream.storyshop.R.string.AttachGif));
                            } else {
                                String name;
                ...
                replyIconImageView.setImageResource(kr.wdream.storyshop.R.drawable.link);
                if (webPage instanceof TLRPC.TL_webPagePending) {
                    replyNameTextView.setText(LocaleController.getString("GettingLinkInfo", kr.wdream.storyshop.R.string.GettingLinkInfo));
                    ...
                    if (webPage.site_name != null) {
                        ...
                        replyNameTextView.setText(LocaleController.getString("LinkPreview", kr.wdream.storyshop.R.string.LinkPreview));
                    }
    ...
    private void updateSecretStatus() {
        ...
        if (currentEncryptedChat instanceof TLRPC.TL_encryptedChatRequested) {
            bottomOverlayText.setText(LocaleController.getString("EncryptionProcessing", kr.wdream.storyshop.R.string.EncryptionProcessing));
            bottomOverlay.setVisibility(View.VISIBLE);
            hideKeyboard = true;
        } else if (currentEncryptedChat instanceof TLRPC.TL_encryptedChatWaiting) {
            bottomOverlayText.setText(AndroidUtilities.replaceTags(LocaleController.formatString("AwaitingEncryption", kr.wdream.storyshop.R.string.AwaitingEncryption, "<b>" + currentUser.first_name + "</b>")));
            bottomOverlay.setVisibility(View.VISIBLE);
            hideKeyboard = true;
        } else if (currentEncryptedChat instanceof TLRPC.TL_encryptedChatDiscarded) {
            bottomOverlayText.setText(LocaleController.getString("EncryptionRejected", kr.wdream.storyshop.R.string.EncryptionRejected));
            bottomOverlay.setVisibility(View.VISIBLE);
            chatActivityEnterView.setFieldText("");
    ...
    private void updateTitle() {
        ...
        if (currentChat != null) {
            ...
            if (currentUser.self) {
                avatarContainer.setTitle(LocaleController.getString("ChatYourSelfName", kr.wdream.storyshop.R.string.ChatYourSelfName));
    ...
    private void updateTitleIcons() {
        ...
        int rightIcon = MessagesController.getInstance().isDialogMuted(dialog_id) ? kr.wdream.storyshop.R.drawable.mute_fixed : 0;
        avatarContainer.setTitleIcons(currentEncryptedChat != null ? kr.wdream.storyshop.R.drawable.ic_lock_header : 0, rightIcon);
        if (muteItem != null) {
            if (rightIcon != 0) {
                muteItem.setText(LocaleController.getString("UnmuteNotifications", kr.wdream.storyshop.R.string.UnmuteNotifications));
            } else {
                muteItem.setText(LocaleController.getString("MuteNotifications", kr.wdream.storyshop.R.string.MuteNotifications));
            }
        }
    }
    ...
    private void showAttachmentError() {
        ...
        Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("UnsupportedAttachment", kr.wdream.storyshop.R.string.UnsupportedAttachment), Toast.LENGTH_SHORT);
        toast.show();
    }
 ...
 // 메시지가 추가 (보내기 받기 될 경우 실행됨
                ...
                if (currentEncryptedChat != null && arr.size() == 1) {
                    ...
                    if (currentEncryptedChat != null && obj.isOut() && obj.messageOwner.action != null && obj.messageOwner.action instanceof TLRPC.TL_messageEncryptedAction &&
                        ...
                        if (AndroidUtilities.getPeerLayerVersion(currentEncryptedChat.layer) < 17 && currentEncryptedChat.ttl > 0 && currentEncryptedChat.ttl <= 60) {
                            ...
                            builder.setTitle(LocaleController.getString("AppName", kr.wdream.storyshop.R.string.AppName));
                            builder.setPositiveButton(LocaleController.getString("OK", kr.wdream.storyshop.R.string.OK), null);
                            builder.setMessage(LocaleController.formatString("CompatibilityChat", kr.wdream.storyshop.R.string.CompatibilityChat, currentUser.first_name, currentUser.first_name));
                            showDialog(builder.create());
                        }
                    }
                }
            ...
            if (currentChat != null && currentChat.id == chatId) {
                ...
                builder.setTitle(LocaleController.getString("AppName", kr.wdream.storyshop.R.string.AppName));
                if (reason == 0) {
                    builder.setMessage(LocaleController.getString("ChannelCantOpenPrivate", kr.wdream.storyshop.R.string.ChannelCantOpenPrivate));
                } else if (reason == 1) {
                    builder.setMessage(LocaleController.getString("ChannelCantOpenNa", kr.wdream.storyshop.R.string.ChannelCantOpenNa));
                } else if (reason == 2) {
                    builder.setMessage(LocaleController.getString("ChannelCantOpenBanned", kr.wdream.storyshop.R.string.ChannelCantOpenBanned));
                }
                builder.setPositiveButton(LocaleController.getString("OK", kr.wdream.storyshop.R.string.OK), null);
    ...
    private void updateSearchButtons(int mask, int num, int count) {
        if (searchUpButton != null) {
            ...
            if (count == 0) {
                ...
                searchCountText.setText(LocaleController.formatString("Of", kr.wdream.storyshop.R.string.Of, num + 1, count));
            }
        }
    }
    ...
    private void updateBottomOverlay() {
        ...
        if (currentChat != null) {
            if (ChatObject.isChannel(currentChat) && !(currentChat instanceof TLRPC.TL_channelForbidden)) {
                if (ChatObject.isNotInChat(currentChat)) {
                    bottomOverlayChatText.setText(LocaleController.getString("ChannelJoin", kr.wdream.storyshop.R.string.ChannelJoin));
                } else {
                    if (!MessagesController.getInstance().isDialogMuted(dialog_id)) {
                        bottomOverlayChatText.setText(LocaleController.getString("ChannelMute", kr.wdream.storyshop.R.string.ChannelMute));
                    } else {
                        bottomOverlayChatText.setText(LocaleController.getString("ChannelUnmute", kr.wdream.storyshop.R.string.ChannelUnmute));
                    }
                }
            } else {
                bottomOverlayChatText.setText(LocaleController.getString("DeleteThisGroup", kr.wdream.storyshop.R.string.DeleteThisGroup));
            }
        } else {
            if (userBlocked) {
                if (currentUser.bot) {
                    bottomOverlayChatText.setText(LocaleController.getString("BotUnblock", kr.wdream.storyshop.R.string.BotUnblock));
                } else {
                    bottomOverlayChatText.setText(LocaleController.getString("Unblock", kr.wdream.storyshop.R.string.Unblock));
                }
                if (botButtons != null) {
                    botButtons = null;
                    if (chatActivityEnterView != null) {
                ...
                bottomOverlayChatText.setText(LocaleController.getString("BotStart", kr.wdream.storyshop.R.string.BotStart));
                chatActivityEnterView.hidePopup(false);
                if (getParentActivity() != null) {
                    AndroidUtilities.hideKeyboard(getParentActivity().getCurrentFocus());
                }
            } else {
                bottomOverlayChatText.setText(LocaleController.getString("DeleteThisChat", kr.wdream.storyshop.R.string.DeleteThisChat));
            }
        }
    ...
    private void updatePinnedMessageView(boolean animated) {
        ...
        if (info == null || info.pinned_msg_id == 0 || info.pinned_msg_id == preferences.getInt("pin_" + dialog_id, 0) || actionBar != null && actionBar.isActionModeShowed()) {
            ...
            if (pinnedMessageObject != null) {
                ...
                pinnedMessageNameTextView.setText(LocaleController.getString("PinnedMessage", kr.wdream.storyshop.R.string.PinnedMessage));
    ...
    private void updateContactStatus() {
        ...
        if (currentUser == null) {
            ...
            if (currentEncryptedChat != null && !(currentEncryptedChat instanceof TLRPC.TL_encryptedChat)
                ...
                if (currentUser.phone != null && currentUser.phone.length() != 0) {
                    addContactItem.setText(LocaleController.getString("AddToContacts", kr.wdream.storyshop.R.string.AddToContacts));
                    ...
                    addContactItem.setText(LocaleController.getString("ShareMyContactInfo", kr.wdream.storyshop.R.string.ShareMyContactInfo));
                    addToContactsButton.setVisibility(View.GONE);
                    reportSpamButton.setPadding(AndroidUtilities.dp(50), 0, AndroidUtilities.dp(50), 0);
    ...
    private void createDeleteMessagesAlert(final MessageObject finalSelectedObject) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setMessage(LocaleController.formatString("AreYouSureDeleteMessages", kr.wdream.storyshop.R.string.AreYouSureDeleteMessages, LocaleController.formatPluralString("messages", finalSelectedObject != null ? 1 : selectedMessagesIds[0].size() + selectedMessagesIds[1].size())));
        ...
        if (currentChat != null && currentChat.megagroup) {
            ...
            if (user != null && user.id != UserConfig.getClientUserId()) {
                ...
                for (int a = 0; a < 3; a++) {
                    ...
                    cell.setTag(a);
                    if (a == 0) {
                        cell.setText(LocaleController.getString("DeleteBanUser", kr.wdream.storyshop.R.string.DeleteBanUser), "", false, false);
                    } else if (a == 1) {
                        cell.setText(LocaleController.getString("DeleteReportSpam", kr.wdream.storyshop.R.string.DeleteReportSpam), "", false, false);
                    } else if (a == 2) {
                        cell.setText(LocaleController.formatString("DeleteAllFrom", kr.wdream.storyshop.R.string.DeleteAllFrom, ContactsController.formatName(user.first_name, user.last_name)), "", false, false);
                    }
            ...
            if (type >= 0) {
                ...
                if (type == 0) {
                    ...
                    if (currentChat != null && !isBroadcast) {
                        ...
                        if (allowUnpin) {
                            items.add(LocaleController.getString("UnpinMessage", kr.wdream.storyshop.R.string.UnpinMessage));
                            options.add(14);
                        } else if (allowPin) {
                            items.add(LocaleController.getString("PinMessage", kr.wdream.storyshop.R.string.PinMessage));
                            options.add(13);
                        }
                        if (allowEdit) {
                    ...
                    if (currentEncryptedChat == null) {
                        ...
                        if (type == 3) {
                            if (selectedObject.messageOwner.media instanceof TLRPC.TL_messageMediaWebPage && MessageObject.isNewGifDocument(selectedObject.messageOwner.media.webpage.document)) {
                                items.add(LocaleController.getString("SaveToGIFs", kr.wdream.storyshop.R.string.SaveToGIFs));
                                options.add(11);
                            }
                        } else if (type == 4) {
                            if (selectedObject.isVideo()) {
                                items.add(LocaleController.getString("SaveToGallery", kr.wdream.storyshop.R.string.SaveToGallery));
                                options.add(4);
                                items.add(LocaleController.getString("ShareFile", kr.wdream.storyshop.R.string.ShareFile));
                                options.add(6);
                            } else if (selectedObject.isMusic()) {
                                items.add(LocaleController.getString("SaveToMusic", kr.wdream.storyshop.R.string.SaveToMusic));
                                options.add(10);
                                items.add(LocaleController.getString("ShareFile", kr.wdream.storyshop.R.string.ShareFile));
                                options.add(6);
                                ...
                                items.add(LocaleController.getString("SaveToDownloads", kr.wdream.storyshop.R.string.SaveToDownloads));
                                options.add(10);
                                items.add(LocaleController.getString("ShareFile", kr.wdream.storyshop.R.string.ShareFile));
                                options.add(6);
                            } else {
                            ...
                            items.add(LocaleController.getString("ApplyLocalizationFile", kr.wdream.storyshop.R.string.ApplyLocalizationFile));
                            options.add(5);
                            items.add(LocaleController.getString("ShareFile", kr.wdream.storyshop.R.string.ShareFile));
                            options.add(6);
                        } else if (type == 6) {
                            ...
                            if (selectedObject.isMask()) {
                                items.add(LocaleController.getString("AddToMasks", kr.wdream.storyshop.R.string.AddToMasks));
                            } else {
                                items.add(LocaleController.getString("AddToStickers", kr.wdream.storyshop.R.string.AddToStickers));
                            }
                            options.add(9);
                        } else if (type == 8) {
                            ...
                            if (user != null && user.id != UserConfig.getClientUserId() && ContactsController.getInstance().contactsDict.get(user.id) == null) {
                                items.add(LocaleController.getString("AddContactTitle", kr.wdream.storyshop.R.string.AddContactTitle));
                                options.add(15);
                            }
    ...
    private void processSelectedOption(int option) {
        ...
        switch (option) {
            ...
            case 5: {
                ...
                if (locFile != null) {
                    if (LocaleController.getInstance().applyLanguageFile(locFile)) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                        builder.setTitle(LocaleController.getString("AppName", kr.wdream.storyshop.R.string.AppName));
                        builder.setMessage(LocaleController.getString("IncorrectLocalization", kr.wdream.storyshop.R.string.IncorrectLocalization));
                        builder.setPositiveButton(LocaleController.getString("OK", kr.wdream.storyshop.R.string.OK), null);
                        showDialog(builder.create());
                    }
                }
            ...
            case 6: {
                ...
                getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("ShareFile", kr.wdream.storyshop.R.string.ShareFile)), 500);
                break;
            }
            case 7: {
                String path = selectedObject.messageOwner.attachPath;
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (response == null) {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                                    builder.setTitle(LocaleController.getString("AppName", kr.wdream.storyshop.R.string.AppName));
                                    builder.setMessage(LocaleController.getString("EditMessageError", kr.wdream.storyshop.R.string.EditMessageError));
                                    builder.setPositiveButton(LocaleController.getString("OK", kr.wdream.storyshop.R.string.OK), null);
                                    showDialog(builder.create());
            ...
            case 13: {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setMessage(LocaleController.getString("PinMessageAlert", kr.wdream.storyshop.R.string.PinMessageAlert));
                ...
                CheckBoxCell cell = new CheckBoxCell(getParentActivity());
                cell.setBackgroundResource(kr.wdream.storyshop.R.drawable.list_selector);
                cell.setText(LocaleController.getString("PinNotify", kr.wdream.storyshop.R.string.PinNotify), "", true, false);
                cell.setPadding(LocaleController.isRTL ? AndroidUtilities.dp(8) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.dp(8), 0);
    ...
    private void checkEditTimer() {
        ...
        if (dt > 0) {
            if (dt > 5 * 60) {
                ...
                actionModeSubTextView.setText(LocaleController.formatString("TimeToEdit", kr.wdream.storyshop.R.string.TimeToEdit, String.format("%d:%02d", dt / 60, dt % 60)));
            }
            AndroidUtilities.runOnUIThread(new Runnable() {
                @Override
                public void run() {
            ...
            editDoneItem.setVisibility(View.GONE);
            actionModeSubTextView.setText(LocaleController.formatString("TimeToEditExpired", kr.wdream.storyshop.R.string.TimeToEditExpired));
        }
    }
    ...
    private void alertUserOpenError(MessageObject message) {
        ...
        builder.setPositiveButton(LocaleController.getString("OK", kr.wdream.storyshop.R.string.OK), null);
        if (message.type == 3) {
            builder.setMessage(LocaleController.getString("NoPlayerInstalled", kr.wdream.storyshop.R.string.NoPlayerInstalled));
        } else {
            builder.setMessage(LocaleController.formatString("NoHandleAppInstalled", kr.wdream.storyshop.R.string.NoHandleAppInstalled, message.getDocument().mime_type));
        }
        showDialog(builder.create());
    }
    ...
    public void showOpenGameAlert(final TLRPC.TL_game game, final MessageObject messageObject, final String urlStr, boolean ask, final int uid) {
        ...
        if (ask) {
            ...
            builder.setMessage(LocaleController.formatString("BotPermissionGameAlert", kr.wdream.storyshop.R.string.BotPermissionGameAlert, name));
            builder.setPositiveButton(LocaleController.getString("OK", kr.wdream.storyshop.R.string.OK), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void showOpenUrlAlert(final String url, boolean ask) {
        if (Browser.isInternalUrl(url) || !ask) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setTitle(LocaleController.getString("AppName", kr.wdream.storyshop.R.string.AppName));
            builder.setMessage(LocaleController.formatString("OpenUrlAlert", kr.wdream.storyshop.R.string.OpenUrlAlert, url));
            builder.setPositiveButton(LocaleController.getString("Open", kr.wdream.storyshop.R.string.Open), new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Browser.openUrl(getParentActivity(), url, inlineReturn == 0);
                }
                    ...
                    public void didPressedUrl(MessageObject messageObject, final ClickableSpan url, boolean longPress) {
                        ...
                        if (url instanceof URLSpanUserMention) {
                            ...
                            if (longPress) {
                                ...
                                builder.setItems(new CharSequence[]{LocaleController.getString("Open", kr.wdream.storyshop.R.string.Open), LocaleController.getString("Copy", kr.wdream.storyshop.R.string.Copy)}, new DialogInterface.OnClickListener() {
                                    @Override
