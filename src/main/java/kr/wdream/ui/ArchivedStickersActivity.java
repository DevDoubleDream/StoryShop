...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static final String TAG ="ArchivedStickersActivity";
    ...
    public void onFragmentDestroy() {
        ...
        Log.d(TAG, "ArchivedStickersActivity Destory");
    ...
    public View createView(Context context) {
        ...
        if (currentType == StickersQuery.TYPE_IMAGE) {
            actionBar.setTitle(LocaleController.getString("ArchivedStickers", kr.wdream.storyshop.R.string.ArchivedStickers));
        } else {
            actionBar.setTitle(LocaleController.getString("ArchivedMasks", kr.wdream.storyshop.R.string.ArchivedMasks));
        }
        ...
        if (currentType == StickersQuery.TYPE_IMAGE) {
            emptyView.setText(LocaleController.getString("ArchivedStickersEmpty", kr.wdream.storyshop.R.string.ArchivedStickersEmpty));
        } else {
            emptyView.setText(LocaleController.getString("ArchivedMasksEmpty", kr.wdream.storyshop.R.string.ArchivedMasksEmpty));
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    view.setBackgroundResource(kr.wdream.storyshop.R.drawable.list_selector_white);
