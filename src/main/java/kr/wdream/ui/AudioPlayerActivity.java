...
import kr.wdream.storyshop.audioinfo.AudioInfo;
...
import kr.wdream.ui.Components.LineProgressView;
...
public class AudioPlayerActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, MediaController.FileDownloadProgressListener {
    ...
    private static final String LOG_TAG = "AudioPlayterActivity";
    ...
    public View createView(Context context) {
        ...
        actionBar.setBackButtonImage(kr.wdream.storyshop.R.drawable.pl_back);
        ...
        prevButton.setImageResource(kr.wdream.storyshop.R.drawable.player_prev_states);
        ...
        playButton.setImageResource(kr.wdream.storyshop.R.drawable.player_play_states);
        ...
        nextButton.setImageResource(kr.wdream.storyshop.R.drawable.player_next_states);
    ...
    private void updateShuffleButton() {
        if (MediaController.getInstance().isShuffleMusic()) {
            shuffleButton.setImageResource(kr.wdream.storyshop.R.drawable.pl_shuffle_active);
        } else {
            shuffleButton.setImageResource(kr.wdream.storyshop.R.drawable.pl_shuffle);
        }
    }
    ...
    private void updateRepeatButton() {
        ...
        if (mode == 0) {
            repeatButton.setImageResource(kr.wdream.storyshop.R.drawable.pl_repeat);
        } else if (mode == 1) {
            repeatButton.setImageResource(kr.wdream.storyshop.R.drawable.pl_repeat_active);
        } else if (mode == 2) {
            repeatButton.setImageResource(kr.wdream.storyshop.R.drawable.pl_repeat1_active);
        }
    }
    ...
    private void updateTitle(boolean shutdown) {
        ...
        if (messageObject == null && shutdown || messageObject != null && !messageObject.isMusic()) {
            ...
            if (MediaController.getInstance().isAudioPaused()) {
                ...
                playButton.setImageResource(kr.wdream.storyshop.R.drawable.player_pause_states);
            }
            if (actionBar != null) {
            ...
            if (audioInfo != null && audioInfo.getCover() != null) {
                ...
                placeholder.setImageResource(kr.wdream.storyshop.R.drawable.nocover);
