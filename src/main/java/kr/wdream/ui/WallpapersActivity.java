...
import kr.wdream.ui.Cells.WallpaperCell;
...
public class WallpapersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static final String LOG_TAG = "WallpapersActivity";
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("ChatBackground", kr.wdream.storyshop.R.string.ChatBackground));
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                if (position == 0) {
                    ...
                    CharSequence[] items = new CharSequence[]{LocaleController.getString("FromCamera", kr.wdream.storyshop.R.string.FromCamera), LocaleController.getString("FromGalley", kr.wdream.storyshop.R.string.FromGalley), LocaleController.getString("Cancel", kr.wdream.storyshop.R.string.Cancel)};
