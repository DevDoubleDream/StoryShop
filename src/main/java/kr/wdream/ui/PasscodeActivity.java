...
public class PasscodeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
        ...
        if (type != 0) {
            ...
            if (type == 1) {
                if (UserConfig.passcodeHash.length() != 0) {
                    titleTextView.setText(LocaleController.getString("EnterNewPasscode", kr.wdream.storyshop.R.string.EnterNewPasscode));
                } else {
                    titleTextView.setText(LocaleController.getString("EnterNewFirstPasscode", kr.wdream.storyshop.R.string.EnterNewFirstPasscode));
                }
            } else {
                titleTextView.setText(LocaleController.getString("EnterCurrentPasscode", kr.wdream.storyshop.R.string.EnterCurrentPasscode));
            }
            ...
            if (type == 1) {
                ...
                dropDownContainer.addSubItem(pin_item, LocaleController.getString("PasscodePIN", kr.wdream.storyshop.R.string.PasscodePIN), 0);
                dropDownContainer.addSubItem(password_item, LocaleController.getString("PasscodePassword", kr.wdream.storyshop.R.string.PasscodePassword), 0);
                ...
                dropDown.setCompoundDrawablesWithIntrinsicBounds(0, 0, kr.wdream.storyshop.R.drawable.ic_arrow_drop_down, 0);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                    if (i == changePasscodeRow) {
                        ...
                        builder.setTitle(LocaleController.getString("AutoLock", kr.wdream.storyshop.R.string.AutoLock));
                        ...
                        numberPicker.setFormatter(new NumberPicker.Formatter() {
                            ...
                            public String format(int value) {
                                if (value == 0) {
                                    return LocaleController.getString("AutoLockDisabled", kr.wdream.storyshop.R.string.AutoLockDisabled);
                                } else if (value == 1) {
                                    return LocaleController.formatString("AutoLockInTime", kr.wdream.storyshop.R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 1));
                                } else if (value == 2) {
                                    return LocaleController.formatString("AutoLockInTime", kr.wdream.storyshop.R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 5));
                                } else if (value == 3) {
                                    return LocaleController.formatString("AutoLockInTime", kr.wdream.storyshop.R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 1));
                                } else if (value == 4) {
                                    return LocaleController.formatString("AutoLockInTime", kr.wdream.storyshop.R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 5));
                                }
                                return "";
                            }
                        });
                        builder.setView(numberPicker);
                        builder.setNegativeButton(LocaleController.getString("Done", kr.wdream.storyshop.R.string.Done), new DialogInterface.OnClickListener() {
                            @Override
    ...
    private void updateDropDownTextView() {
        if (dropDown != null) {
            if (currentPasswordType == 0) {
                dropDown.setText(LocaleController.getString("PasscodePIN", kr.wdream.storyshop.R.string.PasscodePIN));
            } else if (currentPasswordType == 1) {
                dropDown.setText(LocaleController.getString("PasscodePassword", kr.wdream.storyshop.R.string.PasscodePassword));
            }
        }
    ...
    private void processNext() {
        ...
        if (currentPasswordType == 0) {
            actionBar.setTitle(LocaleController.getString("PasscodePIN", kr.wdream.storyshop.R.string.PasscodePIN));
        } else {
            actionBar.setTitle(LocaleController.getString("PasscodePassword", kr.wdream.storyshop.R.string.PasscodePassword));
        }
    ...
    private void processDone() {
        ...
        if (type == 1) {
            if (!firstPassword.equals(passwordEditText.getText().toString())) {
                try {
                    Toast.makeText(getParentActivity(), LocaleController.getString("PasscodeDoNotMatch", kr.wdream.storyshop.R.string.PasscodeDoNotMatch), Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    FileLog.e("tmessages", e);
                }
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (viewType == 0) {
                ...
                if (i == passcodeRow) {
                    textCell.setTextAndCheck(LocaleController.getString("Passcode", kr.wdream.storyshop.R.string.Passcode), UserConfig.passcodeHash.length() > 0, true);
                } else if (i == fingerprintRow) {
                    textCell.setTextAndCheck(LocaleController.getString("UnlockFingerprint", kr.wdream.storyshop.R.string.UnlockFingerprint), UserConfig.useFingerprint, true);
                }
            } else if (viewType == 1) {
                if (view == null) {
                ...
                if (i == changePasscodeRow) {
                    textCell.setText(LocaleController.getString("ChangePasscode", kr.wdream.storyshop.R.string.ChangePasscode), false);
                    textCell.setTextColor(UserConfig.passcodeHash.length() == 0 ? 0xffc6c6c6 : 0xff000000);
                } else if (i == autoLockRow) {
                    String val;
                    if (UserConfig.autoLockIn == 0) {
                        val = LocaleController.formatString("AutoLockDisabled", kr.wdream.storyshop.R.string.AutoLockDisabled);
                    } else if (UserConfig.autoLockIn < 60 * 60) {
                        val = LocaleController.formatString("AutoLockInTime", kr.wdream.storyshop.R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", UserConfig.autoLockIn / 60));
                    } else if (UserConfig.autoLockIn < 60 * 60 * 24) {
                        val = LocaleController.formatString("AutoLockInTime", kr.wdream.storyshop.R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", (int) Math.ceil(UserConfig.autoLockIn / 60.0f / 60)));
                    } else {
                        val = LocaleController.formatString("AutoLockInTime", kr.wdream.storyshop.R.string.AutoLockInTime, LocaleController.formatPluralString("Days", (int) Math.ceil(UserConfig.autoLockIn / 60.0f / 60 / 24)));
                    }
                    textCell.setTextAndValue(LocaleController.getString("AutoLock", kr.wdream.storyshop.R.string.AutoLock), val, true);
                ...
                if (i == passcodeDetailRow) {
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("ChangePasscodeInfo", kr.wdream.storyshop.R.string.ChangePasscodeInfo));
                    ...
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("AutoLockInfo", kr.wdream.storyshop.R.string.AutoLockInfo));
                    view.setBackgroundResource(kr.wdream.storyshop.R.drawable.greydivider_bottom);
                }
            }
            return view;
