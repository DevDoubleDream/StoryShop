...
import kr.wdream.ui.Cells.SessionCell;
...
public class SessionsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static final String LOG_TAG = "SessionsActivity";
    ...
    public View createView(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString("SessionsTitle", kr.wdream.storyshop.R.string.SessionsTitle));
        ...
        emptyLayout.setBackgroundResource(kr.wdream.storyshop.R.drawable.greydivider_bottom);
        ...
        imageView.setImageResource(kr.wdream.storyshop.R.drawable.devices);
        ...
        textView.setText(LocaleController.getString("NoOtherSessions", kr.wdream.storyshop.R.string.NoOtherSessions));
        ...
        textView.setText(LocaleController.getString("NoOtherSessionsInfo", kr.wdream.storyshop.R.string.NoOtherSessionsInfo));
        emptyLayout.addView(textView);
        layoutParams2 = (LinearLayout.LayoutParams) textView.getLayoutParams();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int i, long l) {
                if (i == terminateAllSessionsRow) {
                    ...
                    builder.setMessage(LocaleController.getString("AreYouSureSessions", kr.wdream.storyshop.R.string.AreYouSureSessions));
                                    ...
                                    AndroidUtilities.runOnUIThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            if (error == null && response instanceof TLRPC.TL_boolTrue) {
                                                Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("TerminateAllSessions", kr.wdream.storyshop.R.string.TerminateAllSessions), Toast.LENGTH_SHORT);
                                                toast.show();
                                            } else {
                                                Toast toast = Toast.makeText(getParentActivity(), LocaleController.getString("UnknownError", kr.wdream.storyshop.R.string.UnknownError), Toast.LENGTH_SHORT);
                                                toast.show();
                                            }
                                            finishFragment();
                                        }
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    builder.setMessage(LocaleController.getString("TerminateSessionQuestion", kr.wdream.storyshop.R.string.TerminateSessionQuestion));
                    builder.setTitle(LocaleController.getString("AppName", kr.wdream.storyshop.R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", kr.wdream.storyshop.R.string.OK), new DialogInterface.OnClickListener() {
                        @Override
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == terminateAllSessionsRow) {
                    ...
                    textCell.setText(LocaleController.getString("TerminateAllSessions", kr.wdream.storyshop.R.string.TerminateAllSessions), false);
                }
            } else if (type == 1) {
                if (view == null) {
                ...
                if (i == terminateAllSessionsDetailRow) {
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("ClearOtherSessionsHelp", kr.wdream.storyshop.R.string.ClearOtherSessionsHelp));
                    view.setBackgroundResource(kr.wdream.storyshop.R.drawable.greydivider);
                } else if (i == otherSessionsTerminateDetail) {
                    ((TextInfoPrivacyCell) view).setText(LocaleController.getString("TerminateSessionInfo", kr.wdream.storyshop.R.string.TerminateSessionInfo));
                ...
                if (i == currentSessionSectionRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("CurrentSession", kr.wdream.storyshop.R.string.CurrentSession));
                } else if (i == otherSessionsSectionRow) {
                    ((HeaderCell) view).setText(LocaleController.getString("OtherSessions", kr.wdream.storyshop.R.string.OtherSessions));
                }
            } else if (type == 3) {
