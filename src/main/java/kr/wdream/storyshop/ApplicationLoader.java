...
import kr.wdream.ui.Components.ForegroundDetector;
...
public class ApplicationLoader extends Application {
    ...
    public static File getFilesDirFixed() {
        ...
        return new File("/data/data/kr.toptalk.messenger/files");
    }

    public static void postInitApplication() {

        Log.d("ApplicationLoader", "postInitApplication");

        if (applicationInited) {
            Log.d("ApplicationLoader", "applicationInited : " + applicationInited);
            return;
        }
        ...
        try {
            Log.d("ApplicationLoader", "로케일 정보 받아오기");
        ...
        try {
            ...
            Log.d("ApplicationLoader", "리시버 등록");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        Log.d("ApplicationLoader", "Notifiation : " + preferences.getAll());
