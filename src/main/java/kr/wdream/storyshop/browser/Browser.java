...
package kr.wdream.storyshop.browser;
...
import kr.wdream.storyshop.ShareBroadcastReceiver;
import kr.wdream.storyshop.support.customtabs.CustomTabsCallback;
import kr.wdream.storyshop.support.customtabs.CustomTabsClient;
import kr.wdream.storyshop.support.customtabs.CustomTabsIntent;
import kr.wdream.storyshop.support.customtabs.CustomTabsServiceConnection;
import kr.wdream.storyshop.support.customtabs.CustomTabsSession;
import kr.wdream.storyshop.support.customtabsclient.shared.CustomTabsHelper;
import kr.wdream.storyshop.support.customtabsclient.shared.ServiceConnection;
import kr.wdream.storyshop.support.customtabsclient.shared.ServiceConnectionCallback;
import kr.wdream.ui.ActionBar.Theme;
import kr.wdream.ui.LaunchActivity;
    ...
    public static void openUrl(Context context, Uri uri, boolean allowCustom) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 15 && allowCustom && MediaController.getInstance().canCustomTabs() && !internalUri && !scheme.equals("tel")) {
                ...
                builder.setActionButton(BitmapFactory.decodeResource(context.getResources(), kr.wdream.storyshop.R.drawable.abc_ic_menu_share_mtrl_alpha), LocaleController.getString("ShareFile", kr.wdream.storyshop.R.string.ShareFile), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 0, share, 0), false);
