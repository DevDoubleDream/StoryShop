...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "kr.toptalk.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "kr.toptalk.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "kr.toptalk.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "kr.toptalk.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "kr.toptalk.android.musicplayer.next";
