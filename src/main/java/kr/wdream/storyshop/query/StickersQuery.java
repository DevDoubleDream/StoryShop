...
package kr.wdream.storyshop.query;
...
import kr.wdream.ui.Components.StickersArchiveAlert;
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                if (error == null) {
                                    if (stickerSet.masks) {
                                        Toast.makeText(context, LocaleController.getString("MasksRemoved", kr.wdream.storyshop.R.string.MasksRemoved), Toast.LENGTH_SHORT).show();
                                    } else {
                                        Toast.makeText(context, LocaleController.getString("StickersRemoved", kr.wdream.storyshop.R.string.StickersRemoved), Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    Toast.makeText(context, LocaleController.getString("ErrorOccurred", kr.wdream.storyshop.R.string.ErrorOccurred), Toast.LENGTH_SHORT).show();
                                }
                            } catch (Exception e) {
                                FileLog.e("tmessages", e);
                            }
