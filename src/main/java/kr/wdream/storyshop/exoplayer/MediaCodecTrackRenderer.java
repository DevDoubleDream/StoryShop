 ...
 */
package kr.wdream.storyshop.exoplayer;
...
import kr.wdream.storyshop.exoplayer.MediaCodecUtil.DecoderQueryException;
import kr.wdream.storyshop.exoplayer.drm.DrmInitData;
import kr.wdream.storyshop.exoplayer.drm.DrmSessionManager;
import kr.wdream.storyshop.exoplayer.drm.FrameworkMediaCrypto;
import kr.wdream.storyshop.exoplayer.util.Assertions;
import kr.wdream.storyshop.exoplayer.util.NalUnitUtil;
import kr.wdream.storyshop.exoplayer.util.TraceUtil;
...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "kr.toptalk.messenger.exoplayer.MediaCodecTrackRenderer_" + sign + Math.abs(errorCode);
    }
