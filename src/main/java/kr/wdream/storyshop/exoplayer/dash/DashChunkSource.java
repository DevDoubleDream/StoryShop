 ...
 */
package kr.wdream.storyshop.exoplayer.dash;

import android.os.Handler;
import android.util.Log;
import android.util.SparseArray;
import kr.wdream.storyshop.exoplayer.BehindLiveWindowException;
import kr.wdream.storyshop.exoplayer.C;
import kr.wdream.storyshop.exoplayer.MediaFormat;
import kr.wdream.storyshop.exoplayer.TimeRange;
import kr.wdream.storyshop.exoplayer.chunk.Chunk;
import kr.wdream.storyshop.exoplayer.chunk.ChunkExtractorWrapper;
import kr.wdream.storyshop.exoplayer.chunk.ChunkOperationHolder;
import kr.wdream.storyshop.exoplayer.chunk.ChunkSource;
import kr.wdream.storyshop.exoplayer.chunk.ContainerMediaChunk;
import kr.wdream.storyshop.exoplayer.chunk.Format;
import kr.wdream.storyshop.exoplayer.chunk.Format.DecreasingBandwidthComparator;
import kr.wdream.storyshop.exoplayer.chunk.FormatEvaluator;
import kr.wdream.storyshop.exoplayer.chunk.InitializationChunk;
import kr.wdream.storyshop.exoplayer.chunk.MediaChunk;
import kr.wdream.storyshop.exoplayer.chunk.SingleSampleMediaChunk;
import kr.wdream.storyshop.exoplayer.dash.mpd.AdaptationSet;
import kr.wdream.storyshop.exoplayer.dash.mpd.ContentProtection;
import kr.wdream.storyshop.exoplayer.dash.mpd.MediaPresentationDescription;
import kr.wdream.storyshop.exoplayer.dash.mpd.Period;
import kr.wdream.storyshop.exoplayer.dash.mpd.RangedUri;
import kr.wdream.storyshop.exoplayer.dash.mpd.Representation;
import kr.wdream.storyshop.exoplayer.drm.DrmInitData;
import kr.wdream.storyshop.exoplayer.extractor.ChunkIndex;
import kr.wdream.storyshop.exoplayer.extractor.mp4.FragmentedMp4Extractor;
import kr.wdream.storyshop.exoplayer.extractor.webm.WebmExtractor;
import kr.wdream.storyshop.exoplayer.upstream.DataSource;
import kr.wdream.storyshop.exoplayer.upstream.DataSpec;
import kr.wdream.storyshop.exoplayer.util.Clock;
import kr.wdream.storyshop.exoplayer.util.ManifestFetcher;
import kr.wdream.storyshop.exoplayer.util.MimeTypes;
import kr.wdream.storyshop.exoplayer.util.SystemClock;
...
public class DashChunkSource implements ChunkSource, DashTrackSelector.Output {
  ...
  private TimeRange getAvailableRange(long nowUnixTimeUs) {
    ...
    if (!currentManifest.dynamic || lastPeriod.isIndexExplicit()) {
      return new TimeRange.StaticTimeRange(firstPeriod.getAvailableStartTimeUs(),
    ...
    return new TimeRange.DynamicTimeRange(minStartPositionUs, maxEndPositionUs, elapsedRealtimeAtZeroUs,
