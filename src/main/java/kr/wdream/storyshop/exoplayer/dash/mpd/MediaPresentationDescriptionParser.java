...
import kr.wdream.storyshop.exoplayer.ParserException;
import kr.wdream.storyshop.exoplayer.chunk.Format;
import kr.wdream.storyshop.exoplayer.extractor.mp4.PsshAtomUtil;
import kr.wdream.storyshop.exoplayer.upstream.UriLoadable;
import kr.wdream.storyshop.exoplayer.util.Assertions;
import kr.wdream.storyshop.exoplayer.util.MimeTypes;
import kr.wdream.storyshop.exoplayer.util.ParserUtil;
import kr.wdream.storyshop.exoplayer.util.UriUtil;
...
public class MediaPresentationDescriptionParser extends DefaultHandler
  ...
  protected ContentProtection parseContentProtection(XmlPullParser xpp)
    ...
    do {
      ...
      if (ParserUtil.isStartTag(xpp, "cenc:pssh") && xpp.next() == XmlPullParser.TEXT) {
        ...
        data = new DrmInitData.SchemeInitData(MimeTypes.VIDEO_MP4,
  ...
  protected Representation parseRepresentation(XmlPullParser xpp, String baseUrl,
    ...
    return buildRepresentation(contentId, -1, format,
        segmentBase != null ? segmentBase : new SegmentBase.SingleSegmentBase(baseUrl));
  }
  ...
  protected SegmentBase.SingleSegmentBase parseSegmentBase(XmlPullParser xpp, String baseUrl,
                                                           SegmentBase.SingleSegmentBase parent) throws XmlPullParserException, IOException {
  ...
  protected SegmentBase.SingleSegmentBase buildSingleSegmentBase(RangedUri initialization, long timescale,
                                                                 long presentationTimeOffset, String baseUrl, long indexStart, long indexLength) {
    return new SegmentBase.SingleSegmentBase(initialization, timescale, presentationTimeOffset, baseUrl,
        indexStart, indexLength);
  }

  protected SegmentBase.SegmentList parseSegmentList(XmlPullParser xpp, String baseUrl, SegmentBase.SegmentList parent)
      throws XmlPullParserException, IOException {
  ...
  protected SegmentBase.SegmentList buildSegmentList(RangedUri initialization, long timescale,
                                                     long presentationTimeOffset, int startNumber, long duration,
                                                     List<SegmentBase.SegmentTimelineElement> timeline, List<RangedUri> segments) {
    return new SegmentBase.SegmentList(initialization, timescale, presentationTimeOffset,
        startNumber, duration, timeline, segments);
  }

  protected SegmentBase.SegmentTemplate parseSegmentTemplate(XmlPullParser xpp, String baseUrl,
                                                             SegmentBase.SegmentTemplate parent) throws XmlPullParserException, IOException {
  ...
  protected SegmentBase.SegmentTemplate buildSegmentTemplate(RangedUri initialization, long timescale,
                                                             long presentationTimeOffset, int startNumber, long duration,
                                                             List<SegmentBase.SegmentTimelineElement> timeline, UrlTemplate initializationTemplate,
                                                             UrlTemplate mediaTemplate, String baseUrl) {
    return new SegmentBase.SegmentTemplate(initialization, timescale, presentationTimeOffset,
        startNumber, duration, timeline, initializationTemplate, mediaTemplate, baseUrl);
  }

  protected List<SegmentBase.SegmentTimelineElement> parseSegmentTimeline(XmlPullParser xpp)
      throws XmlPullParserException, IOException {
