...
import kr.wdream.storyshop.exoplayer.MediaCodecUtil;
...
public final class VideoFormatSelectorUtil {
  ...
  public static int[] selectVideoFormats(List<? extends FormatWrapper> formatWrappers,
      ...
      boolean secureDecoder, int viewportWidth, int viewportHeight) throws MediaCodecUtil.DecoderQueryException {
  ...
  private static boolean isFormatPlayable(Format format, String[] allowedContainerMimeTypes,
      boolean filterHdFormats, boolean secureDecoder) throws MediaCodecUtil.DecoderQueryException {
