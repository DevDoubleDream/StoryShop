 ...
 */
package kr.wdream.storyshop.exoplayer.extractor;
...
import kr.wdream.storyshop.exoplayer.MediaFormatHolder;
import kr.wdream.storyshop.exoplayer.ParserException;
import kr.wdream.storyshop.exoplayer.SampleHolder;
import kr.wdream.storyshop.exoplayer.SampleSource;
import kr.wdream.storyshop.exoplayer.SampleSource.SampleSourceReader;
import kr.wdream.storyshop.exoplayer.TrackRenderer;
import kr.wdream.storyshop.exoplayer.drm.DrmInitData;
import kr.wdream.storyshop.exoplayer.upstream.Allocator;
import kr.wdream.storyshop.exoplayer.upstream.DataSource;
import kr.wdream.storyshop.exoplayer.upstream.DataSpec;
import kr.wdream.storyshop.exoplayer.upstream.Loader;
import kr.wdream.storyshop.exoplayer.upstream.Loader.Loadable;
...
import kr.wdream.storyshop.exoplayer.extractor.flv.FlvExtractor;
import kr.wdream.storyshop.exoplayer.extractor.mp3.Mp3Extractor;
import kr.wdream.storyshop.exoplayer.extractor.mp4.FragmentedMp4Extractor;
import kr.wdream.storyshop.exoplayer.extractor.mp4.Mp4Extractor;
import kr.wdream.storyshop.exoplayer.extractor.ogg.OggExtractor;
import kr.wdream.storyshop.exoplayer.extractor.ts.AdtsExtractor;
import kr.wdream.storyshop.exoplayer.extractor.ts.PsExtractor;
import kr.wdream.storyshop.exoplayer.extractor.ts.TsExtractor;
import kr.wdream.storyshop.exoplayer.extractor.wav.WavExtractor;
...
public final class ExtractorSampleSource implements SampleSource, SampleSourceReader,
  ...
  static {
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("kr.toptalk.messenger.exoplayer.ext.flac.FlacExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
